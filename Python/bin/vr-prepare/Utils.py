...
class FloatInRangeControlBase(QtWidgets.QWidget, Ui_FloatInRangeControlBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QWidget.__init__(self, parent, f)
        self.setupUi(self)
        
class ExitConfirmationBase(QtWidgets.QDialog, Ui_ExitConfirmationBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
        self.setupUi(self)
        
class DialogOverwriteFileBase(QtWidgets.QDialog, Ui_DialogOverwriteFileBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
        self.setupUi(self)
        
class DialogFileNewBase(QtWidgets.QDialog, Ui_DialogFileNewBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
        self.setupUi(self)
        
class NewViewpointConfirmationBase(QtWidgets.QDialog, Ui_NewViewpointConfirmationBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
        self.setupUi(self)
        
class DialogReduceTimeStepAskerBase(QtWidgets.QDialog, Ui_DialogReduceTimeStepAskerBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
        self.setupUi(self)
class DialogChangePathBase(QtWidgets.QDialog, Ui_DialogChangePathBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
        self.setupUi(self)
        
class DialogOkayAskerBase(QtWidgets.QDialog, Ui_DialogOkayAskerBase):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        QtWidgets.QDialog.__init__(self, parent, f)
...
class FloatInRangeControl(FloatInRangeControlBase):

    sigValueChanged = pyqtSignal(float)
    sigSliderReleased = pyqtSignal()
    
    def __init__(self,parent = None,name = None,fl = 0):
        FloatInRangeControlBase.__init__(self, parent)
...
class IntInRangeControl(FloatInRangeControlBase):
...
class ReallyWantToOverrideAsker(DialogOverwriteFileBase):

    def __init__(self, parent, filename):
        DialogOverwriteFileBase.__init__(self, parent)
        self.textLabel_fileName.setText(filename)

class FileNewAsker(DialogFileNewBase):

    def __init__(self, parent):
        DialogFileNewBase.__init__(self, parent)

class SaveBeforeExitAsker(ExitConfirmationBase):
    
    def __init__(self, parent):
        ExitConfirmationBase.__init__(self, parent)
...
class NewViewpointAsker(NewViewpointConfirmationBase):

    def __init__(self, parent):
         NewViewpointConfirmationBase.__init__(self, parent)
         self.__pressedButton = None
...
class ReduceTimestepAsker(DialogReduceTimeStepAskerBase):

    def __init__(self):
        global _reduceDecision
        DialogReduceTimeStepAskerBase.__init__(self, None)
    ...
    def exec_loop(self):
        global _reduceDecision
        if _reduceDecision == None:
            return DialogReduceTimeStepAskerBase.exec_loop(self)
        else:
            return self.accept()
...
class OkayAsker(DialogOkayAskerBase):

    def __init__(self, parent, text):
        DialogOkayAskerBase.__init__(self, parent)
...
class ChangePathAsker(DialogChangePathBase):                

    def __init__(self, nameDataset, parent):
        DialogChangePathBase.__init__(self, parent)
        ...
        self.accepted.connect(self.__buttonYesPressed)
        self.rejected.connect(self.__buttonNoPressed)
...
def unpickleProjectFile(filename, replaceInPathList = []):
    ...
    replaceList = [ (b'(cImportManager\nImportSample2DModule', b'(cImportSampleManager\nImportSample2DModule'),
                    (b'(cImportManager\nImportSample3DModule', b'(cImportSampleManager\nImportSample3DModule'),
                    (b'(cImportManager\nImportGroup3DModule', b'(cImportGroupManager\nImportGroup3DModule'),
                    (b'(cImportManager\nImportGroup2DModule', b'(cImportGroupManager\nImportGroup2DModule'),
                    (b'(cVRPImportManager\nImportSample2DModule', b'(cImportSampleManager\nImportSample2DModule'),
                    (b'(cVRPImportManager\nImportSample3DModule', b'(cImportSampleManager\nImportSample3DModule'),
                    (b'(cVRPImportManager\nImportGroup3DModule', b'(cImportGroupManager\nImportGroup3DModule'),
                    (b'(cVRPImportManager\nImportGroup2DModule', b'(cImportGroupManager\nImportGroup2DModule'),
                    (b'(cVRPImportSampleManager\n', b'(cImportSampleManager\n'),
                    (b'(cVRPImportGroupManager\n', b'(cImportGroupManager\n'),
                    (b'(cVRPImportManager\n', b'(cImportManager\n'),
                    (b'PartIsoPlaneVis', b'PartIsoSurfaceVis' ),
                    (b' (scalar)', b''),
                    (b'Part2DRawVisParamsMaterialsAlu', b'Part2DRawVisParams') ,
                    (b'flyMode', b'flyingMode')]
