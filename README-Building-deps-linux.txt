...
#osgearth
cmake .. -DCMAKE_INSTALL_PREFIX=${EXTERNLIBS}/osgEarth -DCESIUM_NATIVE_DIR=$EXTERNLIBS/cesium-native -DOSGEARTH_BUILD_CESIUM_NODEKIT=ON -DCMAKE_PREFIX_PATH=$EXTERNLIBS/openscenegraph
...
#vsg:
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_PREFIX_PATH="${EXTERNLIBS}/vsg;${EXTERNLIBS}/osg2vsg;${EXTERNLIBS}/openscenegraph;${EXTERNLIBS}/vsgXchange;${EXTERNLIBS}/assimp" -DCMAKE_INSTALL_PREFIX=${EXTERNLIBS}/vsg
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_PREFIX_PATH="${EXTERNLIBS}/vsg;${EXTERNLIBS}/osg2vsg;${EXTERNLIBS}/openscenegraph;${EXTERNLIBS}/vsgXchange;${EXTERNLIBS}/assimp" -DCMAKE_INSTALL_PREFIX=${EXTERNLIBS}/osg2vsg
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_PREFIX_PATH="${EXTERNLIBS}/vsg;${EXTERNLIBS}/osg2vsg;${EXTERNLIBS}/openscenegraph;${EXTERNLIBS}/vsgXchange;${EXTERNLIBS}/assimp" -DCMAKE_INSTALL_PREFIX=${EXTERNLIBS}/vsgXchange
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCMAKE_PREFIX_PATH="${EXTERNLIBS}/vsg;${EXTERNLIBS}/osg2vsg;${EXTERNLIBS}/openscenegraph;${EXTERNLIBS}/vsgXchange;${EXTERNLIBS}/assimp" -DCMAKE_INSTALL_PREFIX=${EXTERNLIBS}/vsgPoints
