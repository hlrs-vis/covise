...
{
    /// <summary>
    /// Alphat-Parameter for HeatTransfer.
    /// </summary>
    public class Alphat : FOAMParameter<double>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public Alphat(Version version, string path, Dictionary<string, object> attributes, SaveFormat format, Settings settings, List<string> _wallNames,
            List<string> _InletNames, List<string> _OutletNames, List<string> _SlipNames)
            : base(version, path, attributes, format, settings, "alphat", "volScalarField", _wallNames, _InletNames, _OutletNames, _SlipNames)
        {
