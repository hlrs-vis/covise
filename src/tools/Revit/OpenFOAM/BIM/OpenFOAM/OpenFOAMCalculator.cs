...
namespace BIM.OpenFOAMExport.OpenFOAM
{
    ...
    public class OpenFOAMCalculator
    {
        ...
        public double CalculateReynoldsnumber(double meanFlowVelocity, double kinematicViscosity, double characteristicLength)
        {
            return meanFlowVelocity * characteristicLength / kinematicViscosity;
        }
        ...
        public double CalculateHydraulicDiameter(double area, double boundaryLength)
        {
            return 4 * area / boundaryLength;
        }
        ...
        public double EstimateTurbulenceIntensityPipe(double reynoldsNumber)
        {
        ...
        public double EstimateTurbulencLengthScalePipe(double hydraulicDiameter)
        {
            //for fully developed piped flows.
            //Source: https://www.cfd-online.com/Wiki/Turbulence_length_scale
            return 0.038 * hydraulicDiameter;
        }
