...
namespace BIM.OpenFOAMExport.OpenFOAM
{
    ...
    public class Nut : FOAMParameter<double>
    {
        ...
        public Nut(Version version, string path, Dictionary<string, object> attributes, SaveFormat format, Settings settings, List<string> _wallNames,
            List<string> _InletNames, List<string> _OutletNames, List<string> _SlipNames)
            : base(version, path, attributes, format, settings, "nut", "volScalarField", _wallNames, _InletNames, _OutletNames, _SlipNames)
        {
        }
