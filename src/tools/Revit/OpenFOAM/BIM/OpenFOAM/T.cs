...
namespace BIM.OpenFOAMExport.OpenFOAM
{
    ...
    /// </summary>
    public class T : FOAMParameter<double>
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public T(Version version, string path, Dictionary<string, object> attributes, SaveFormat format, Settings settings, List<string> _wallNames,
            List<string> _InletNames, List<string> _OutletNames, List<string> _SlipNames)
            : base(version, path, attributes, format, settings, "T", "volScalarField", _wallNames, _InletNames, _OutletNames, _SlipNames)
        {
        }
        ...
        {
            m_Dimensions = new int[] { 0, 0, 0, 1, 0, 0, 0 };
