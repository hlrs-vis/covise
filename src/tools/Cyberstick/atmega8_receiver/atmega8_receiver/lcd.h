...
void lcd_send(char data)
{
    ...
    sbi(PORTC, 0); // Impuls auf E geben
    cbi(PORTC, 0);
...
void lcd_init(void)
{
    ...
    DDRC |= (1 << PC0) | (1 << PC1); // PortC0-1 als Ausgang setzen
    PORTC &= ~((1 << PC0) | (1 << PC1)); // PortC0-1 auf 0
    _delay_ms(50);

    PORTC &= ~((1 << PC0) | (1 << PC1)); // PortC0-1 weider auf 0s
