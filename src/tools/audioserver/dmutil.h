...
public:
    ...
    HRESULT Initialize(HWND hWnd, DWORD dwPChannels = 128, DWORD dwDefaultPathType = DMUS_APATH_DYNAMIC_3D);
...
public:
    ...
    inline IDirectMusicSegment8 *GetSegment()
    {
        return m_pSegment;
    }
...
public:
    ...
    inline IDirectMusicScript8 *GetScript()
    {
        return m_pScript;
    }
