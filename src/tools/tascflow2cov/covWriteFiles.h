...
#ifndef EC_UNSTRGRD_H
extern int TYPE_HEXAGON;
extern int TYPE_HEXAEDER;
extern int TYPE_PRISM;
extern int TYPE_PYRAMID;
extern int TYPE_TETRAHEDER;
extern int TYPE_QUAD;
extern int TYPE_TRIANGLE;
extern int TYPE_BAR;
extern int TYPE_NONE;
...
int FILEEXPORT covOpenOutFile(char *filename);
