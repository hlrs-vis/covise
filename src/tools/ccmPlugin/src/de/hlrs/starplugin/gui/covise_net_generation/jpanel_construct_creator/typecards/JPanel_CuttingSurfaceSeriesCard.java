 ...
 */
public class JPanel_CuttingSurfaceSeriesCard extends JPanel {

    private GridBagLayout layout;
    private JLabel JLabel_Direction;
    private JLabel JLabel_Distance;
    private JTextField JTextField_Distance;
    private JLabel JLabel_NumberOfCuts;
    private JTextField JTextField_NumberOfCuts;
    private JLabel JLabel_DistanceBetween;
    private JTextField JTextField_DistanceBetween;
    ...
    private final JComboBox<String> JComboBox_DataTypeChooser;
    private final JComboBox<Object> JComboBox_DataChooser;

    public JPanel_CuttingSurfaceSeriesCard() {
        super();
        ...
        //Line Number of Cuts
        JLabel_NumberOfCuts = new JLabel("Number of Cuts");
        GBCon = GetGridBagConstraints.get(0, 3, 0, 0, new Insets(
                5, 5, 0, 0),
                GridBagConstraints.NONE,
                GridBagConstraints.LINE_START);
        GBCon.gridwidth = 1;
        this.add(JLabel_NumberOfCuts, GBCon);

        JTextField_NumberOfCuts = new JTextField("0");
        GBCon = GetGridBagConstraints.get(1, 3, 0, 0, new Insets(5, 5, 0, 0),
                GridBagConstraints.NONE,
                GridBagConstraints.LINE_START);
        JTextField_NumberOfCuts.setPreferredSize(Dimension_inputField);
        this.add(JTextField_NumberOfCuts, GBCon);

        //Distance between Cuts
        JLabel_DistanceBetween = new JLabel("Cutting Distance");
        GBCon = GetGridBagConstraints.get(0, 4, 0, 0, new Insets(
                5, 5, 0, 0),
                GridBagConstraints.NONE,
                GridBagConstraints.LINE_START);
        GBCon.gridwidth = 1;
        this.add(JLabel_DistanceBetween, GBCon);

        JTextField_DistanceBetween = new JTextField("0");
        GBCon = GetGridBagConstraints.get(1, 4, 0, 0, new Insets(5, 5, 0, 0),
                GridBagConstraints.NONE,
                GridBagConstraints.LINE_START);
        JTextField_DistanceBetween.setPreferredSize(Dimension_inputField);
        this.add(JTextField_DistanceBetween, GBCon);

        //Chosen Gemtery Tree
        //Headline
        JLabel Headline = new JLabel("Choose Regions to cut");

        GBCon = GetGridBagConstraints.get(0, 5, 0, 0, new Insets(5, 5, 0, 0),
                GridBagConstraints.NONE,
                GridBagConstraints.FIRST_LINE_START);
        GBCon.gridheight = 1;
        GBCon.gridwidth = 2;
        ...
        GBCon = GetGridBagConstraints.get(0, 6, 1, 1, new Insets(0, 5, 0, 0),
        ...
        GBCon = GetGridBagConstraints.get(3, 5, 0, 0, new Insets(5, 5, 0, 0),
                GridBagConstraints.NONE,
                GridBagConstraints.FIRST_LINE_START);
        GBCon.gridheight = 1;
        GBCon.gridwidth = 1;
        ...
        GBCon = GetGridBagConstraints.get(3, 6, 1, 1, new Insets(0, 5, 0, 0),
                GridBagConstraints.BOTH,
                GridBagConstraints.FIRST_LINE_START);
        GBCon.gridheight = GridBagConstraints.REMAINDER;
        GBCon.gridwidth = GridBagConstraints.REMAINDER;
    ...
    public JTextField getJTextField_CuttingDistance() {
        return JTextField_DistanceBetween;
    }

    public JTextField getJTextField_NumberOfCuts() {
        return JTextField_NumberOfCuts;
    }
