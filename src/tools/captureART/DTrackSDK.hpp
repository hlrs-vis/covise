...
/* DTrackSDK: C++ header file, A.R.T. GmbH 03.05.07-17.6.13
 *
 ...
 *
 * Files and classes in folder 'Lib' provide type definitions, basic UDP/TCP functionality and string parsing.
 */

#ifndef _ART_DTRACKSDK_HPP_
#define _ART_DTRACKSDK_HPP_

#include "../../OpenCOVER/cover/input/dev/dtrack/Lib/DTrackDataTypes.h"
#include "../../OpenCOVER/cover/input/dev/dtrack/Lib/DTrackNet.h"
#include "../../OpenCOVER/cover/input/dev/dtrack/Lib/DTrackParser.hpp"
...
public:
    ...
    bool isTCPValid()
    {
        return isCommandInterfaceValid();
    }
