...
enum covise_msg_type
{
	...
	COVISE_MESSAGE_VRB_REQUEST_NEW_SESSION, //135
	COVISE_MESSAGE_VRBC_SET_SESSION, //136
	COVISE_MESSAGE_VRBC_SEND_SESSIONS, //137
	COVISE_MESSAGE_VRBC_CHANGE_SESSION, //138
	COVISE_MESSAGE_VRBC_UNOBSERVE_SESSION, //139
	COVISE_MESSAGE_VRB_SAVE_SESSION, //140
	COVISE_MESSAGE_VRB_LOAD_SESSION, //141
	COVISE_MESSAGE_VRB_REQUEST_SAVED_SESSION, //142
	COVISE_MESSAGE_VRB_MESSAGE, //143
...
const char *covise_msg_types_array[COVISE_MESSAGE_LAST_DUMMY_MESSAGE + 1] = {
	...
	"COVISE_MESSAGE_VRB_REQUEST_NEW_SESSION", //135
	"COVISE_MESSAGE_VRBC_SET_SESSION", //136
	"OVISE_MESSAGE_VRBC_SEND_SESSIONS", //137
	"COVISE_MESSAGE_VRBC_CHANGE_SESSION", //138
	"COVISE_MESSAGE_VRBC_UNOBSERVE_SESSION", //139
	"COVISE_MESSAGE_VRB_SAVE_SESSION", //140
	"COVISE_MESSAGE_VRB_LOAD_SESSION", //141
