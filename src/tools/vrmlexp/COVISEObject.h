...
public:
    ...
    const TCHAR* GetObjectName(bool localized) const override { return localized ? GetString(IDS_COVISEOBJECT_CLASS) : _T("COVISEObject"); }
#else
    ...
    virtual
        ...
        GetObjectName()
    {
        return GetString(IDS_COVISEOBJECT_CLASS);
    }
#endif
...
#if MAX_PRODUCT_VERSION_MAJOR > 23
    void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_COVISEOBJECT_CLASS) : _T("COVISEObject"); }
#else

    void GetClassName(TSTR& s)
    {
        s = GetString(IDS_COVISEOBJECT_CLASS);
    }
#endif
    int IsKeyable()
    {
