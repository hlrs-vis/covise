...
public:
    ...
    const TCHAR* GetObjectName(bool localized) const override { return localized ? GetString(IDS_SCRIPT) : _T("Script"); }
#else
...
#if MAX_PRODUCT_VERSION_MAJOR > 23
    void GetClassName(MSTR& s, bool localized) const override { s = localized ? GetString(IDS_SCRIPT_CLASS) : _T("Script"); }
#else

    void GetClassName(TSTR& s)
    {
        s = GetString(IDS_SCRIPT_CLASS);
    }
#endif
    int IsKeyable()
    {
