    ...
    : coGRMsg(SET_TRACKING_PARAMS)
{
    ...
    char str[1024];
    snprintf(str, sizeof(str), "%d", rotatePoint);
    addToken(str);
    snprintf(str, sizeof(str), "%d", rotatePointShown);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotationPointSize);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotatePointX);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotatePointY);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotatePointZ);
    addToken(str);
    snprintf(str, sizeof(str), "%d", rotateAxis);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotateAxisX);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotateAxisY);
    addToken(str);
    snprintf(str, sizeof(str), "%f", rotateAxisZ);
    addToken(str);
    snprintf(str, sizeof(str), "%d", translateRestrict);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateMinX);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateMaxX);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateMinY);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateMaxY);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateMinZ);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateMaxZ);
    addToken(str);
    snprintf(str, sizeof(str), "%f", translateFactor);
    addToken(str);
    snprintf(str, sizeof(str), "%d", scaleRestrict);
    addToken(str);
    snprintf(str, sizeof(str), "%f", scaleMin);
    addToken(str);
    snprintf(str, sizeof(str), "%f", scaleMax);
    addToken(str);
    snprintf(str, sizeof(str), "%f", scaleFactor);
    addToken(str);
    snprintf(str, sizeof(str), "%d", trackingEnable_);
    addToken(str);
