...
namespace covise{
  ...
  DECL_SUB_MESSAGE_CLASS(VRB_PERMIT_LAUNCH, VRB_PERMIT_LAUNCH_TYPE, Ask, COMSGEXPORT, int, senderID, int, launcherID, covise::Program, program);
  ...
  DECL_SUB_MESSAGE_CLASS(VRB_PERMIT_LAUNCH, VRB_PERMIT_LAUNCH_TYPE, Abort, COMSGEXPORT, int, requestorID, int, launcherID, covise::Program, program);
}
