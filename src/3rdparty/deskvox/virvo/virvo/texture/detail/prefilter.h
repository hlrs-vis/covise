#ifndef VV_TEXTURE_PREFILTER_H
#define VV_TEXTURE_PREFILTER_H
...
template < typename T >
void convert_to_bspline_coeffs(T*, size_t, size_t)
{
...
void convert_for_bspline_interpol(texture< T, ReadMode, 1 >* tex)
{
...
template < typename T, tex_read_mode ReadMode >
void convert_for_bspline_interpol(texture< T, ReadMode, 2 >* tex)
{
    using namespace detail;
...
template < typename T, tex_read_mode ReadMode >
void convert_for_bspline_interpol(texture< T, ReadMode, 3 >* tex)
{
    using namespace detail;
