...
class VVCORE_EXPORT vvRenderObject
{
public:
    vvRenderObject();
    virtual ~vvRenderObject();

    virtual const char *getName() const = 0;

    virtual bool isGeometry() const = 0;
    virtual vvRenderObject *getGeometry() const = 0;
    virtual vvRenderObject *getNormals() const = 0;
    virtual vvRenderObject *getColors() const = 0;
    virtual vvRenderObject *getTexture() const = 0;
    virtual vvRenderObject *getVertexAttribute() const = 0;
    virtual vvRenderObject *getColorMap(int idx) const = 0;
    ...
    virtual vvRenderObject *getElement(size_t idx) const = 0;
