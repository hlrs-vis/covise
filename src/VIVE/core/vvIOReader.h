...
public:
     ...
     */
    virtual vsg::Node *load(const std::string &location, vsg::Group *group = 0) = 0;
     ...
     */
    virtual bool unload(vsg::Node *node);
