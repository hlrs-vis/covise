...
inline coCullVisitor::value_type distance(const vsg::vec3 &coord, const vsg::dmat4 &matrix)
{

    //std::cout << "distance("<<coord<<", "<<matrix<<")"<<std::endl;
    vsg::vec3 dist = matrix.preMult(coord);
...
float coCullVisitor::getDistanceFromEyePoint(const vsg::vec3 &pos, bool withLODScale) const
{
...
struct ComputeNearFarFunctor
{
    ...
    void set(CullVisitor::value_type znear, const vsg::dmat4 &matrix, const osg::Polytope::PlaneList *planes)
    {
        _znear = znear;
        _matrix = matrix;
        _planes = planes;
    ...
    typedef std::pair<float, vsg::vec3> DistancePoint;
    ...
    // Handle Points
    inline void operator()(const vsg::vec3 &v1, bool)
    {
    ...
    // Handle Lines
    inline void operator()(const vsg::vec3 &v1, const vsg::vec3 &v2, bool)
    {
        CullVisitor::value_type n1 = distance(v1, _matrix);
    ...
    // Handle Triangles
    inline void operator()(const vsg::vec3 &v1, const vsg::vec3 &v2, const vsg::vec3 &v3, bool)
    {
        CullVisitor::value_type n1 = distance(v1, _matrix);
        CullVisitor::value_type n2 = distance(v2, _matrix);
    ...
    inline void operator()(const vsg::vec3 &v1, const vsg::vec3 &v2, const vsg::vec3 &v3, const vsg::vec3 &v4, bool treatVertexDataAsTemporary)
    {
...
CullVisitor::value_type coCullVisitor::computeNearestPointInFrustum(const vsg::dmat4 &matrix, const osg::Polytope::PlaneList &planes, const vsg::Node &drawable)
{
...
CullVisitor::value_type coCullVisitor::computeFurthestPointInFrustum(const vsg::dmat4 &matrix, const osg::Polytope::PlaneList &planes, const vsg::Node &drawable)
{
...
bool coCullVisitor::updateCalculatedNearFar(const vsg::dmat4 &matrix, const osg::BoundingBox &bb)
{
...
bool coCullVisitor::updateCalculatedNearFar(const vsg::dmat4 &matrix, const vsg::Node &drawable, bool isBillboard)
{
    ...
    if (isBillboard)
    {
        ...
        vsg::vec3 lookVector(-matrix(0, 2), -matrix(1, 2), -matrix(2, 2));
...
void coCullVisitor::updateCalculatedNearFar(const vsg::vec3 &pos)
{
    float d;
    if (!_modelviewStack.empty())
    {
        const vsg::dmat4 &matrix = *(_modelviewStack.back());
...
void coCullVisitor::apply(vsg::Node &drawable)
{
    ...
    if( drawable.getCullCallback() )
    {
        ...
        vsg::NodeCullCallback* dcb = drawable.getCullCallback()->asDrawableCullCallback();
#else
        vsg::Node::CullCallback* dcb = dynamic_cast<vsg::Node::CullCallback *>(drawable.getCullCallback());
#endif
        if (dcb)
        {
