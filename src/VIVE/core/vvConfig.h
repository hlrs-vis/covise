...
struct screenStruct
{
    ...
    vsg::vec3 xyz; // screen center in mm
    vsg::vec3 hpr; // screen orientation in degree euler angles
    std::string name;
    bool render;
...
struct channelStruct
{
    ...
    bool fixedViewer;
    float stereoOffset;
    vsg::dmat4 leftView, rightView;
    vsg::dmat4 leftProj, rightProj;
...
struct PBOStruct
{
    ...
    vsg::ref_ptr<vsg::Image> renderTargetTexture;
...
class VVCORE_EXPORT angleStruct
{
public:
...
class VVCORE_EXPORT vvConfig
{
    friend class vvPluginSupport;
    friend class vvWindows;
    friend class vvSceneGraph;
    friend class vvVIVE;
    friend class vvViewer;

    static vvConfig *s_instance;
