...
template class VVCORE_EXPORT UiConfigValue<Button, bool>;
template class VVCORE_EXPORT UiConfigValue<EditField, std::string>;
template class VVCORE_EXPORT UiConfigValue<FileBrowser, std::string>;
template class VVCORE_EXPORT UiConfigValue<SelectionList, int64_t>;
template class VVCORE_EXPORT UiConfigValue<Slider, double>;
template class VVCORE_EXPORT UiConfigValue<TextField, std::string>;
