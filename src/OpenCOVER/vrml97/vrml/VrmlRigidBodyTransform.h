...
//
//  %W% %G%
//  VrmlRigidBodyTransform.h

#ifndef _VrmlRigidBodyTransform_
#define _VrmlRigidBodyTransform_
...
class VRMLEXPORT VrmlRigidBodyTransform : public VrmlNodeTransform
{
...
public:
    ...
    VrmlRigidBodyTransform(VrmlScene *);
    virtual ~VrmlRigidBodyTransform();
    ...
    //LarryD Feb 24/99
    virtual VrmlRigidBodyTransform *toTransform() const;
    //LarryD Feb 24/99
...
#endif //_VrmlRigidBodyTransform_
