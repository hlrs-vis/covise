...
typedef JSBool (*JS_DLL_CALLBACK JSIdentityOp)(const void *a, const void *b);
...
#define JSXML_CLASS_HAS_NAME(class_) \
    ((uintN)((class_)-JSXML_CLASS_ELEMENT) <= (uintN)(JSXML_CLASS_PROCESSING_INSTRUCTION - JSXML_CLASS_ELEMENT))
...
#define VALUE_IS_XML(cx, v) (!JSVAL_IS_PRIMITIVE(v) && OBJECT_IS_XML(cx, JSVAL_TO_OBJECT(v)))
