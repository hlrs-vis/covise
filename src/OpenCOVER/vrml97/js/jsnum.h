...
#define JSDOUBLE_HI32(x) (__extension__( \
    { jsdpun u; u.d = (x); u.s.hi;       \
    }))
#define JSDOUBLE_LO32(x) (__extension__( \
    { jsdpun u; u.d = (x); u.s.lo;       \
    }))
#define JSDOUBLE_SET_HI32(x, y)                         \
    (__extension__(                                     \
        { jsdpun u; u.d = (x); u.s.hi = (y); (x) = u.d; \
        }))
#define JSDOUBLE_SET_LO32(x, y)                         \
    (__extension__(                                     \
        { jsdpun u; u.d = (x); u.s.lo = (y); (x) = u.d; \
        }))
...
#define JSDOUBLE_IS_NaN(x) \
    ((JSDOUBLE_HI32(x) & JSDOUBLE_HI32_EXPMASK) == JSDOUBLE_HI32_EXPMASK && (JSDOUBLE_LO32(x) || (JSDOUBLE_HI32(x) & JSDOUBLE_HI32_MANTMASK)))

#define JSDOUBLE_IS_INFINITE(x) \
    ((JSDOUBLE_HI32(x) & ~JSDOUBLE_HI32_SIGNBIT) == JSDOUBLE_HI32_EXPMASK && !JSDOUBLE_LO32(x))

#define JSDOUBLE_IS_FINITE(x) \
    ((JSDOUBLE_HI32(x) & JSDOUBLE_HI32_EXPMASK) != JSDOUBLE_HI32_EXPMASK)

#define JSDOUBLE_IS_NEGZERO(d) (JSDOUBLE_HI32(d) == JSDOUBLE_HI32_SIGNBIT && JSDOUBLE_LO32(d) == 0)
