 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSPropertyOp)(JSContext *cx, JSObject *obj, jsval id,
                                               jsval *vp);
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSResolveOp)(JSContext *cx, JSObject *obj, jsval id);
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSNewResolveOp)(JSContext *cx, JSObject *obj, jsval id,
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSConvertOp)(JSContext *cx, JSObject *obj, JSType type,
                                              jsval *vp);
 ...
 */
typedef JSObjectOps *(*JS_DLL_CALLBACK JSGetObjectOps)(JSContext *cx, JSClass *clasp);
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSCheckAccessOp)(JSContext *cx, JSObject *obj, jsval id,
 ...
 * data.  See jsxdrapi.h.
 */
typedef JSBool (*JS_DLL_CALLBACK JSXDRObjectOp)(JSXDRState *xdr, JSObject **objp);
 ...
 * *bp otherwise.
 */
typedef JSBool (*JS_DLL_CALLBACK JSHasInstanceOp)(JSContext *cx, JSObject *obj, jsval v,
                                                  JSBool *bp);
 ...
 */
typedef uint32 (*JS_DLL_CALLBACK JSMarkOp)(JSContext *cx, JSObject *obj, void *arg);
 ...
 * also lock obj.
 */
typedef uint32 (*JS_DLL_CALLBACK JSReserveSlotsOp)(JSContext *cx, JSObject *obj);
 ...
 */
typedef JSObjectMap *(*JS_DLL_CALLBACK JSNewObjectMapOp)(JSContext *cx, jsrefcount nrefs,
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSLookupPropOp)(JSContext *cx, JSObject *obj, jsid id,
 ...
 * JSLookupPropOp.
 */
typedef JSBool (*JS_DLL_CALLBACK JSDefinePropOp)(JSContext *cx, JSObject *obj,
                                                 jsid id, jsval value,
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSPropertyIdOp)(JSContext *cx, JSObject *obj, jsid id,
                                                 jsval *vp);
 ...
 * JSLookupPropOp call.
 */
typedef JSBool (*JS_DLL_CALLBACK JSAttributesOp)(JSContext *cx, JSObject *obj, jsid id,
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSCheckAccessIdOp)(JSContext *cx, JSObject *obj, jsid id,
                                                    JSAccessMode mode, jsval *vp,
                                                    uintN *attrsp);
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSSetObjectSlotOp)(JSContext *cx, JSObject *obj,
 ...
 */
typedef jsval (*JS_DLL_CALLBACK JSGetRequiredSlotOp)(JSContext *cx, JSObject *obj,
                                                     uint32 slot);

typedef JSBool (*JS_DLL_CALLBACK JSSetRequiredSlotOp)(JSContext *cx, JSObject *obj,
                                                      uint32 slot, jsval v);

typedef JSObject *(*JS_DLL_CALLBACK JSGetMethodOp)(JSContext *cx, JSObject *obj, jsid id,
                                                   jsval *vp);

typedef JSBool (*JS_DLL_CALLBACK JSSetMethodOp)(JSContext *cx, JSObject *obj, jsid id,
                                                jsval *vp);

typedef JSBool (*JS_DLL_CALLBACK JSEnumerateValuesOp)(JSContext *cx, JSObject *obj,
                                                      JSIterateOp enum_op,
                                                      jsval *statep, jsid *idp, jsval *vp);

typedef JSBool (*JS_DLL_CALLBACK JSEqualityOp)(JSContext *cx, JSObject *obj, jsval v,
                                               JSBool *bp);

typedef JSBool (*JS_DLL_CALLBACK JSConcatenateOp)(JSContext *cx, JSObject *obj, jsval v,
                                                  jsval *vp);

/* Typedef for native functions called by the JS VM. */

typedef JSBool (*JS_DLL_CALLBACK JSNative)(JSContext *cx, JSObject *obj, uintN argc,
...
typedef JSBool (*JS_DLL_CALLBACK JSGCCallback)(JSContext *cx, JSGCStatus status);

typedef JSBool (*JS_DLL_CALLBACK JSBranchCallback)(JSContext *cx, JSScript *script);

typedef void (*JS_DLL_CALLBACK JSErrorReporter)(JSContext *cx, const char *message,
...
typedef const JSErrorFormatString *(*JS_DLL_CALLBACK JSErrorCallback)(void *userRef, const char *locale,
                                                                      const uintN errorNumber);

#ifdef va_start
#define JS_ARGUMENT_FORMATTER_DEFINED 1

typedef JSBool (*JS_DLL_CALLBACK JSArgumentFormatter)(JSContext *cx, const char *format,
                                                      JSBool fromJS, jsval **vpp,
                                                      va_list *app);
#endif

typedef JSBool (*JS_DLL_CALLBACK JSLocaleToUpperCase)(JSContext *cx, JSString *src,
                                                      jsval *rval);

typedef JSBool (*JS_DLL_CALLBACK JSLocaleToLowerCase)(JSContext *cx, JSString *src,
                                                      jsval *rval);

typedef JSBool (*JS_DLL_CALLBACK JSLocaleCompare)(JSContext *cx,
                                                  JSString *src1, JSString *src2,
                                                  jsval *rval);

typedef JSBool (*JS_DLL_CALLBACK JSLocaleToUnicode)(JSContext *cx, char *src, jsval *rval);
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSPrincipalsTranscoder)(JSXDRState *xdr,
 ...
 */
typedef JSPrincipals *(*JS_DLL_CALLBACK JSObjectPrincipalsFinder)(JSContext *cx, JSObject *obj);
