...
#define JSVAL_INT_MIN ((jsval)((jsuint)1 - (jsuint)JSVAL_INT_POW2(30)))
...
{
public:
    JSAutoLocalRootScope(JSContext *cx)
        : mContext(cx)
    {
...
typedef intN (*JS_DLL_CALLBACK JSGCRootMapFun)(void *rp, const char *name, void *data);
