 ...
 */
typedef void *(*JS_DLL_CALLBACK JSDHashAllocTable)(JSDHashTable *table, uint32 nbytes);

typedef void (*JS_DLL_CALLBACK JSDHashFreeTable)(JSDHashTable *table, void *ptr);
 ...
 */
typedef const void *(*JS_DLL_CALLBACK JSDHashGetKey)(JSDHashTable *table,
 ...
 */
typedef JSDHashNumber (*JS_DLL_CALLBACK JSDHashHashKey)(JSDHashTable *table, const void *key);
 ...
 */
typedef JSBool (*JS_DLL_CALLBACK JSDHashMatchEntry)(JSDHashTable *table,
 ...
 */
typedef void (*JS_DLL_CALLBACK JSDHashMoveEntry)(JSDHashTable *table,
 ...
 */
typedef void (*JS_DLL_CALLBACK JSDHashClearEntry)(JSDHashTable *table,
                                                  JSDHashEntryHdr *entry);
 ...
 */
typedef void (*JS_DLL_CALLBACK JSDHashFinalize)(JSDHashTable *table);
 ...
 * table.
 */
typedef JSBool (*JS_DLL_CALLBACK JSDHashInitEntry)(JSDHashTable *table,
                                                   JSDHashEntryHdr *entry,
                                                   const void *key);
 ...
 */
extern JS_PUBLIC_API(JSDHashEntryHdr *) JS_DHASH_FASTCALL JS_DHashTableOperate(JSDHashTable *table, const void *key, JSDHashOperator op);
 ...
 */
typedef JSDHashOperator (*JS_DLL_CALLBACK JSDHashEnumerator)(JSDHashTable *table, JSDHashEntryHdr *hdr,
