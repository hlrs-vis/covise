...
#define JS_ISALPHA(c) ((((1 << JSCT_UPPERCASE_LETTER) | (1 << JSCT_LOWERCASE_LETTER) | (1 << JSCT_TITLECASE_LETTER) | (1 << JSCT_MODIFIER_LETTER) | (1 << JSCT_OTHER_LETTER)) \
                        >> JS_CTYPE(c)) & 1)

#define JS_ISALNUM(c) ((((1 << JSCT_UPPERCASE_LETTER) | (1 << JSCT_LOWERCASE_LETTER) | (1 << JSCT_TITLECASE_LETTER) | (1 << JSCT_MODIFIER_LETTER) | (1 << JSCT_OTHER_LETTER) | (1 << JSCT_DECIMAL_DIGIT_NUMBER)) \
                        >> JS_CTYPE(c)) & 1)

/* A unicode letter, suitable for use in an identifier. */
#define JS_ISLETTER(c) ((((1 << JSCT_UPPERCASE_LETTER) | (1 << JSCT_LOWERCASE_LETTER) | (1 << JSCT_TITLECASE_LETTER) | (1 << JSCT_MODIFIER_LETTER) | (1 << JSCT_OTHER_LETTER) | (1 << JSCT_LETTER_NUMBER)) \
                         >> JS_CTYPE(c)) & 1)
 ...
 */
#define JS_ISIDPART(c) ((((1 << JSCT_UPPERCASE_LETTER) | (1 << JSCT_LOWERCASE_LETTER) | (1 << JSCT_TITLECASE_LETTER) | (1 << JSCT_MODIFIER_LETTER) | (1 << JSCT_OTHER_LETTER) | (1 << JSCT_LETTER_NUMBER) | (1 << JSCT_NON_SPACING_MARK) | (1 << JSCT_COMBINING_SPACING_MARK) | (1 << JSCT_DECIMAL_DIGIT_NUMBER) | (1 << JSCT_CONNECTOR_PUNCTUATION)) \
                         >> JS_CTYPE(c)) & 1)
...
#define JS_ISXMLSPACE(c) ((c) == ' ' || (c) == '\t' || (c) == '\r' || (c) == '\n')
#define JS_ISXMLNSSTART(c) ((JS_CCODE(c) & 0x00000100) || (c) == '_')
#define JS_ISXMLNS(c) ((JS_CCODE(c) & 0x00000080) || (c) == '.' || (c) == '-' || (c) == '_')
