...
ObjectReference::ObjectReference(const QString &id, Object *object, const odrID &refId, double s, double t, double zOffset, double validLength, Signal::OrientationType orientation, QList<Signal::Validity> validity)
    : RoadSection(s)
	, id_(id)
	, refId_(refId)
	, object_(object)
