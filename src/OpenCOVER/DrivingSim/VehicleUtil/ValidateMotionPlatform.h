...
class ValidateMotionPlatform : public XenomaiTask, public XenomaiSocketCan
{
public:
    ...
    static const unsigned int numLinMots = 3;

    //Absolute limits: SI-Units, Attention: Only provide positive (absolute) valued!
    static const double posMin = 0.02;
    static const double posMax = 0.38;
    static const double posFactorIncPerSI = 1e6;

    static const double velMin = 0.0;
    static const double velMax = 1.0;
    //static const double velMax = 0.1;
    static const double velFactorIncPerSI = 1e4;

    static const double accMin = 0.1;
    static const double accMax = 10.0; //As of 2009-09-17: 20.0 also o.k.!
    //static const double accMax = 1.0;	//As of 2009-09-17: 20.0 also o.k.!
    static const double accFactorIncPerSI = 1e3;

    static const double posMiddle = 0.2;
    static const double sideMotDist = 0.65;
    static const double rearMotDist = 1.1;

    //Control modes
    static const uint16_t controlResetBit = 0x01;
    static const uint16_t controlPositioning = (9 << 5) | (4 << 10); //FCB 9, Instance 4: Positioning
    static const uint16_t controlToGround = (9 << 5) | (3 << 10); //FCB 9, Instance 3: Local Positioning, local vel/acc, setpoint = 0
    static const uint16_t controlInterpolatedPositioning = (10 << 5) | (0 << 10); //FCB 10, Instance 0: Interpolated Positioning
    static const uint16_t controlDisabled = (1 << 5) | (0 << 10); //FCB 1, Instance 0
    static const uint16_t controlReset = (13 << 5) | (0 << 10) | controlResetBit; //FCB 13, Instance 0, Reset-Bit
    static const uint16_t controlMiddleLift = (9 << 5) | (2 << 10); //FCB 9, Instance 2: Positioning, dummy for lift to middle position
    static const uint16_t controlReference = (12 << 5) | (0 << 10); //FCB 12, Instance 0: Referencing
    static const uint16_t controlTorque = (8 << 5) | (0 << 10); //FCB 8, Instance 0: Interpolated torque control
    ...
    static const unsigned int numRotMots = 1;
    static const double forceFactorPercentPerSI = 1000.0; // [0.001N/N], 3 digits behind floating point
    static const double posFactorSIPerMM = 0.00001; // [m/0.01mm], 2 digits behind floating point
    static const double velFactorSIPerMM = 0.000001; // [m/0.001mm], 3 digits behind floating point
    static const double accFactorSIPerDegree = 2.112; // [m/0.01degree], 2 digits behind floating point

    //Interval-Time
    static const RTIME h_ns = 1000000;
