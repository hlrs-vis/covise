...
typedef tuple<typeof(dp_b),
              typeof(grade<1>(((!q_b) * ((grade<1>((!q_wfl) * part<2, 0x0201>(W_wfl) * q_wfl + (!q_wfr) * part<2, 0x0201>(W_wfr) * q_wfr + part<2, 0x0201>(W_wrl) + part<2, 0x0201>(W_wrr)) + (Fsd_wfl + Fsd_wfr + Fsd_wrl + Fsd_wrr)) * (1.0 / m_b)) * q_b)) + g),
              typeof(q_b *w_b * 0.5),
              typeof(grade<2>((!q_b) * rigidbody::euler<590, 1730, 1950>(q_b * w_b * (!q_b),
                                                                         r_wfl * (Fsd_wfl + grade<1>((!q_wfl) * part<2, 0x0201>(W_wfl) * q_wfl) - (u_wfl - u_wfr) * k_arb) + r_wfr * (Fsd_wfr + grade<1>((!q_wfr) * part<2, 0x0201>(W_wfr) * q_wfr) + (u_wfl - u_wfr) * k_arb) + r_wrl * (Fsd_wrl + part<2, 0x0201>(W_wrl)) + r_wrr * (Fsd_wrr + part<2, 0x0201>(W_wrr))) * q_b)),
              typeof(du_wfl),
              typeof((Fsd_wfl - part<1, 0x04>(W_wfl)) * (1.0 / m_w)),
              typeof(du_wfr),
              typeof((Fsd_wfr - part<1, 0x04>(W_wfr)) * (1.0 / m_w)),
              typeof(du_wrl),
              ...
              typeof(R_n_wfl *exp(y *u_wfl *(-0.5))),
              typeof(R_n_wfr *exp(y *u_wfr *(0.5))),
...
static ExpressionVectorType getExpressionVector()
{
    ...
    ExpressionVectorType exprVec(
        dp_b,
        grade<1>(((!q_b) * ((grade<1>((!q_wfl) * part<2, 0x0201>(W_wfl) * q_wfl + (!q_wfr) * part<2, 0x0201>(W_wfr) * q_wfr + part<2, 0x0201>(W_wrl) + part<2, 0x0201>(W_wrr)) + (Fsd_wfl + Fsd_wfr + Fsd_wrl + Fsd_wrr)) * (1.0 / m_b)) * q_b)) + g,
        q_b * w_b * 0.5,
        grade<2>((!q_b) * rigidbody::euler<590, 1730, 1950>(q_b * w_b * (!q_b),
                                                            r_wfl * (Fsd_wfl + grade<1>((!q_wfl) * part<2, 0x0201>(W_wfl) * q_wfl) - (u_wfl - u_wfr) * k_arb) + r_wfr * (Fsd_wfr + grade<1>((!q_wfr) * part<2, 0x0201>(W_wfr) * q_wfr) + (u_wfl - u_wfr) * k_arb) + r_wrl * (Fsd_wrl + part<2, 0x0201>(W_wrl)) + r_wrr * (Fsd_wrr + part<2, 0x0201>(W_wrr))) * q_b),
        du_wfl,
        (Fsd_wfl - part<1, 0x04>(W_wfl)) * (1.0 / m_w),
        du_wfr,
        (Fsd_wfr - part<1, 0x04>(W_wfr)) * (1.0 / m_w),
        du_wrl,
        ...
        R_n_wfl * exp(y * u_wfl * (-0.5)),
        R_n_wfr * exp(y * u_wfr * (0.5)),
