...
#define OSC_OBJECT_ADD_MEMBER_CHOICE(varName,typeName) varName.setName(#varName); varName.registerWith(this); varName.setType(varName.getValueType()); varName.setTypeName(typeName); varName.registerChoiceWith(this)
...
public:
    ...
    std::vector<oscMember *> getChoice() const;
