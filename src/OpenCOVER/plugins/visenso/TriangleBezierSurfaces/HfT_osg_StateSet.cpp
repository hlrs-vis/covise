...
void HfT_osg_StateSet::createTriangleMode(Vec4 color)
{
    ...
    m_ColorTriangle = color;
    setColorAndMaterial_Triangle(m_ColorTriangle, m_MaterialTriangle);
...
void HfT_osg_StateSet::createShadeMode(Vec4 color)
{
    ...
    this->setAttribute /*AndModes*/ (m_MaterialShade, StateAttribute::PROTECTED);
}
...
void HfT_osg_StateSet::setColorAndMaterial_Triangle(Vec4 Color, Material *Mat)
{
