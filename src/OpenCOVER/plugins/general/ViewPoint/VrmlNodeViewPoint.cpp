...
void VrmlNodeViewPoint::initFields(VrmlNodeViewPoint *node, VrmlNodeType *t)
{
    ...
    initFieldsHelper(node, t,
        exposedField("transitionDuration", &VrmlNodeViewPoint::d_transitionDuration, [node](auto f)
        ...
        exposedField("viewPointName", &VrmlNodeViewPoint::d_viewPointName, [node](auto n)
