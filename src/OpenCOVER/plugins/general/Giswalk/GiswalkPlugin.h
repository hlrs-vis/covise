...
#ifndef _Giswalk_PLUGIN_H
#define _Giswalk_PLUGIN_H
/****************************************************************************\
**                                                            (C)2005 HLRS  **
**                                                                          **
** Description: Giswalk Plugin (records viewpoints and viewing directions and targets)                              **
**                                                                          **
**                                                                          **
** Author: U.Woessner		                                                 **
**                                                                          **
...
#include "../tools/giswalk/giswalk.h"
#include <osg/Geode>
#include <osg/ref_ptr>
...
class GiswalkPlugin : public coVRPlugin, public coTUIListener
{
public:
    GiswalkPlugin();
    virtual ~GiswalkPlugin();
    static GiswalkPlugin *instance();
    bool init();

    int loadGCode(const char *filename, osg::Group *loadParent);
    static int sloadGCode(const char *filename, osg::Group *loadParent);
    static int unloadGCode(const char *filename);
...
private:
    ...
    static GiswalkPlugin *thePlugin;
