...
#ifndef CO_PRECIPITATIONEFFECT
#define CO_PRECIPITATIONEFFECT
...
class VRML97COVEREXPORT coPrecipitationEffect : public osg::Node
{
public:

    coPrecipitationEffect();
    coPrecipitationEffect(const coPrecipitationEffect& copy, const osg::CopyOp& copyop = osg::CopyOp::SHALLOW_COPY);

    virtual const char* libraryName() const { return "osgParticle"; }
    virtual const char* className() const { return "coPrecipitationEffect"; }
    virtual bool isSameKindAs(const osg::Object* obj) const { return dynamic_cast<const coPrecipitationEffect*>(obj) != 0; }
    ...
    class VRML97COVEREXPORT PrecipitationDrawable : public osg::Drawable
    {
    public:
