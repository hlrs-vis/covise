...
osgText::Text *KoordAxis::createAxisLabel(const std::string &iLabel, const osg::Vec3 &iPosition)
{
    ...
    txtLabel->setText(iLabel, osgText::String::ENCODING_UTF8);
...
osg::Geometry *KoordAxis::createArrow(const osg::Matrixd &iTransform, const osg::Vec4 &iColor, double iHeight)
{
    ...
    osg::ref_ptr<osg::Vec3Array> coord = new osg::Vec3Array(7);
    (*coord)[0].set(iTransform.preMult(osg::Vec3d(outerBaseRadius, 0.0, pyramidBaseZ)));
    (*coord)[1].set(iTransform.preMult(osg::Vec3d(0.0, outerBaseRadius, pyramidBaseZ)));
    (*coord)[2].set(iTransform.preMult(osg::Vec3d(-outerBaseRadius, 0.0, pyramidBaseZ)));
    (*coord)[3].set(iTransform.preMult(osg::Vec3d(0.0, -outerBaseRadius, pyramidBaseZ)));
    (*coord)[4].set(iTransform.preMult(osg::Vec3d(0.0, 0.0, iHeight)));
    (*coord)[5].set(iTransform.preMult(osg::Vec3d(0.0, 0.0, iHeight)));
    (*coord)[6].set(iTransform.preMult(osg::Vec3d(0.0, 0.0, 0.0)));
