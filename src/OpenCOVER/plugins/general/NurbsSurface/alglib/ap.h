...
extern ae_int64_t _alloc_counter_total;
...
extern ae_int64_t _malloc_failure_after;
...
#define _ALGLIB_CALLBACK_EXCEPTION_GUARD_END(state)     }catch(...){alglib_impl::ae_assert(ae_false, "ALGLIB: exception generated in user callback",state);}
...
#define _ALGLIB_CALLBACK_EXCEPTION_GUARD_END(state)
...
#ifdef AE_COMPILE_QPCHOLESKYSOLVER
#define AE_PARTIAL_BUILD
#define AE_COMPILE_APSERV
#define AE_COMPILE_HQRND
#define AE_COMPILE_TSORT
...
#define AE_COMPILE_QPCHOLESKYSOLVER
#endif
