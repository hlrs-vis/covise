...
#define swap32IfLE(l) \
    (*(char *)&endianTest ? ((((l)&0xff000000) >> 24) | (((l)&0x00ff0000) >> 8) | (((l)&0x0000ff00) << 8) | (((l)&0x000000ff) << 24)) : (l))
...
#define rfbSharedAppKeyboardEvent 40
#define rfbSharedAppPointerEvent 41
...
/*-----------------------------------------------------------------------------
 * SharedAppUpdate - the server has an update for a 'seamless window'
 */
typedef struct
{
    CARD8 type; /* always rfbSharedAppUpdate */
    CARD8 pad;
    CARD16 numRects;
    CARD32 windowId;
    CARD32 parentId;
    rfbRectangle updateRect;
    CARD16 cursorOffsetX;
