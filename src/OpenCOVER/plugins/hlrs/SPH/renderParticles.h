...
{
public:
    ParticleRenderer(fluidDrawable *fd);
    ~ParticleRenderer();
    ...
    osgSimBuffer *GetCudaBufferPosition();
    osgSimBuffer *GetCudaBufferColors();

protected: // methods
    void _initGL();
    void _createTexture(int resolution);
    void _drawPoints(bool color, int numActiveParticles);
...
protected: // data
    ...
    osgSimBuffer *mCudaBufferPosition;
    osgSimBuffer *mCudaBufferColor;
