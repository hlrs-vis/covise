    ...
    cutFindFilePath(const char *filename, const char *executable_path)
{
    ...
    char *file_path = (char *)malloc(sizeof(char) * (data_folder_len + filename_len + 1));
    ...
    file_path = (char *)malloc(sizeof(char) * (executable_path_len + projects_relative_path_len + 1 + data_folder_len + filename_len + 1));
    ...
    if (*(file_path + file_path_len - 1) == 'e' && *(file_path + file_path_len - 2) == 'x' && *(file_path + file_path_len - 3) == 'e' && *(file_path + file_path_len - 4) == '.')
    {
