...
void
RennteamPlugin::newInteractor(RenderObject *container, coInteractor *i)
{
    (void)container;
    (void)i;
    fprintf(stderr, "RennteamPlugin::newInteractor\n");
}

void RennteamPlugin::addObject(RenderObject *container,
                               ...
                               float *xn, float *yn, float *zn, float transparency)
{
    ...
    (void)zn;
    (void)transparency;
    fprintf(stderr, "RennteamPlugin::addObject\n");
}

void
RennteamPlugin::removeObject(const char *objName, bool replace)
{
    (void)objName;
    (void)replace;
    fprintf(stderr, "RennteamPlugin::removeObject\n");
}
