...
grid_regular_compressed() : grid_regular_compressed(1, 1.0, scm::math::vec3d(0.0, 0.0, 0.0), std::vector<node_t>())
{
}

grid_regular_compressed::
grid_regular_compressed(const size_t& number_cells, const double& cell_size, const scm::math::vec3d& position_center, const std::vector<node_t>& ids) : grid_regular(number_cells, cell_size, position_center, ids)
{
}
