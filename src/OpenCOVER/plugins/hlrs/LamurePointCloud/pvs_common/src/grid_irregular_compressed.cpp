...
grid_irregular_compressed() : grid_irregular_compressed(1, 1, 1, 1.0, scm::math::vec3d(0.0, 0.0, 0.0), std::vector<node_t>())
{
}

grid_irregular_compressed::
grid_irregular_compressed(const size_t& number_cells_x, const size_t& number_cells_y, const size_t& number_cells_z, const double& bounds_size, const scm::math::vec3d& position_center, const std::vector<node_t>& ids)
						: grid_irregular(number_cells_x, number_cells_y, number_cells_z, bounds_size, position_center, ids)
{
}
...
std::string grid_irregular_compressed::
get_grid_type() const
{
...
get_grid_identifier()
{
	return "irregular_compressed";
}

void grid_irregular_compressed::
