...
void VrmlNodeJAKA::initFields(VrmlNodeJAKA* node, vrml::VrmlNodeType* t)
{
    ...
    initFieldsHelper(node, t,
        exposedField("speed", &VrmlNodeJAKA::d_speed, [node](auto f) {
            }),
        exposedField("lademodus", &VrmlNodeJAKA::d_lademodus, [node](auto f) {
            }),
        eventOutCallBack("position", &VrmlNodeJAKA::d_position, [node](auto f) {
            }),
        eventOutCallBack("rotation", &VrmlNodeJAKA::d_rotation, [node](auto f) {
            }),
        eventOutCallBack("main0Angle", &VrmlNodeJAKA::d_main0Angle, [node](auto f) {
            }),
        eventOutCallBack("main1Angle", &VrmlNodeJAKA::d_main1Angle, [node](auto f) {
            }),
        eventOutCallBack("main2Angle", &VrmlNodeJAKA::d_main2Angle, [node](auto f) {
            }),
        eventOutCallBack("sec0Angle", &VrmlNodeJAKA::d_sec0Angle, [node](auto f) {
            }),
        eventOutCallBack("sec1Angle", &VrmlNodeJAKA::d_sec1Angle, [node](auto f) {
            }),
        eventOutCallBack("sec2Angle", &VrmlNodeJAKA::d_sec2Angle, [node](auto f) {
            })
        );
    if (t)
    {
