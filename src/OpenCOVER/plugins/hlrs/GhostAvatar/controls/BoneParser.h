#ifndef COVER_PLUGIN_GHOSTAVATAR_CONTROLS_BoneParser_H
#define COVER_PLUGIN_GHOSTAVATAR_CONTROLS_BoneParser_H
...
#endif // COVER_PLUGIN_GHOSTAVATAR_CONTROLS_BoneParser_H