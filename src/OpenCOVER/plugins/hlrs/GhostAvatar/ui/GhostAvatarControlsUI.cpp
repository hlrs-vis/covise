...
void GhostAvatarControlsUI::createArmSettingsMenu()
{
    ...
    m_armBaseVectorField = new ui::VectorEditField(m_armSettingsMenu, "Base Vector");
    ...
    m_armAdjustMatrixMenu = new ui::Menu(m_armSettingsMenu, "Adjust Matrix");
    for (int row = 0; row < 3; ++row)
    {
        ...
        m_armAdjustMatrixFields[row] = new ui::VectorEditField(m_armAdjustMatrixMenu, label);
...
void GhostAvatarControlsUI::createHeadSettingsMenu()
{
    ...
    m_headBaseVectorField = new ui::VectorEditField(m_headSettingsMenu, "Base Vector");
    ...
    m_headAdjustMatrixMenu = new ui::Menu(m_headSettingsMenu, "Adjust Matrix");
    for (int row = 0; row < 3; ++row)
    {
        ...
        std::string label = "Row " + std::to_string(row);
        m_headAdjustMatrixFields[row] = new ui::VectorEditField(m_headAdjustMatrixMenu, label);
