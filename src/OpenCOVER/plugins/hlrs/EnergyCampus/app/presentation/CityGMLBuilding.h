 ...
 *
 * Inherits from prototype::core::interface::IBuilding and manages graphical representation using OpenSceneGraph (OSG) geodes.
 ...
 */
class CityGMLBuilding : public prototype::core::interface::IBuilding {
 public:
