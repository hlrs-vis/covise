...
void
OpenCRGPlugin::newInteractor(RenderObject *container, coInteractor *i)
{
    (void)container;
    (void)i;
    fprintf(stderr, "OpenCRGPlugin::newInteractor\n");
}

void OpenCRGPlugin::addObject(RenderObject *container,
                              ...
                              float *xn, float *yn, float *zn, float transparency)
{
    ...
    (void)zn;
    (void)transparency;
    fprintf(stderr, "OpenCRGPlugin::addObject\n");
}

void
OpenCRGPlugin::removeObject(const char *objName, bool replace)
{
    (void)objName;
    (void)replace;
    fprintf(stderr, "OpenCRGPlugin::removeObject\n");
}
