...
void
TrafficSimulation::newInteractor(RenderObject *, coInteractor *i)
{
    (void)i;
    fprintf(stderr, "TrafficSimualtion::newInteractor\n");
}

void TrafficSimulation::addObject(RenderObject *container,
                                        ...
                                        float *xn, float *yn, float *zn, float transparency)
{
    ...
    (void)zn;
    (void)transparency;
    fprintf(stderr, "TrafficSimualtion::addObject\n");
}

void
TrafficSimulation::removeObject(const char *objName, bool replace)
{
    (void)objName;
    (void)replace;
    fprintf(stderr, "TrafficSimualtion::removeObject\n");
}
