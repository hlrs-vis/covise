...
//#include "PacejkaMagicFormulaCGA.h"
...
typedef std::tuple<D_type, //Displacement versor wheel hub front left
                   ...
                   S_type, //Tyre model force wrench front left
                   S_type, //Tyre model force wrench front right
                   S_type, //Tyre model force wrench rear left
                   S_type //Tyre model force wrench rear right
                   > OutputVector;
...
struct StateEquation
{
    StateEquation(const InputVector &input_,
        ...
        /*const delfttyre97CGA::ContactWrench& tyre_fl_,
                  const delfttyre97CGA::ContactWrench& tyre_fr_,
                  const delfttyre97CGA::ContactWrench& tyre_rl_,
                  const delfttyre97CGA::ContactWrench& tyre_rr_)*/
        : input(input_),
          output(output_),
          tyre_fl(tyre_fl_),
          tyre_fr(tyre_fr_),
    ...
    /*delfttyre97CGA::ContactWrench tyre_fl;
   delfttyre97CGA::ContactWrench tyre_fr;
   delfttyre97CGA::ContactWrench tyre_rl;
   delfttyre97CGA::ContactWrench tyre_rr;*/
...
} //end namespace cardyncga

//class PLUGINEXPORT CarDynamicsCGA
class CarDynamicsCGA : public VehicleDynamics, OpenThreads::Thread
{
public:
    CarDynamicsCGA();
    virtual ~CarDynamicsCGA();
...
protected:
    ...
    /*delfttyre97CGA::ContactWrench tyreFL;
   delfttyre97CGA::ContactWrench tyreFR;
   delfttyre97CGA::ContactWrench tyreRL;
   delfttyre97CGA::ContactWrench tyreRR;*/
