...
#define PROLOG(func_name, dst_type)                                                                                                     \
    static int func_name(SwsContext *c, uint8_t *src[], int srcStride[], int srcSliceY, int srcSliceH, uint8_t *dst[], int dstStride[]) \
    {                                                                                                                                   \
        int y;                                                                                                                          \
                                                                                                                                        \
        ...
        {                                                                                                                               \
            ...
            dst_type /*av_unused*/ *r = NULL, *b = NULL;                                                                                \
            dst_type *g;                                                                                                                \
...
#define EPILOG(dst_delta) EPILOG1(dst_delta) EPILOG2()
                          ...
                          int saturation)
{
    ...
    for (i = 0; i < 256; i++)
    {
        c->table_rV[i] = (uint8_t *)table_r + entry_size * div_round((int)(crv * (i - 128)), 76309);
        c->table_gU[i] = (uint8_t *)table_g + entry_size * div_round((int)(cgu * (i - 128)), 76309);
        c->table_gV[i] = entry_size * div_round((int)(cgv * (i - 128)), 76309);
        c->table_bU[i] = (uint8_t *)table_b + entry_size * div_round((int)(cbu * (i - 128)), 76309);
    }
