...
public:
    ...
    coTUILabel *capPos = nullptr;
    coTUILabel *capArea = nullptr;
    coTUILabel *videoSize = nullptr;
    coTUILabel *errorLabel = nullptr;
    coTUILabel *fileErrorLabel = nullptr;
    coTUITab *VideoTab = nullptr;
    coTUIEditField *fileNameField = nullptr;
    coTUIToggleButton *captureButton = nullptr;
    coTUIToggleButton *sizeButton = nullptr;
    coTUIComboBox *GLformatButton = nullptr;
    coTUIEditIntField *xPosField = nullptr;
    coTUIEditIntField *yPosField = nullptr;
    coTUIEditIntField *widthField = nullptr;
    coTUIEditIntField *heightField = nullptr;
    coTUIEditIntField *outWidthField = nullptr;
    coTUIEditIntField *outHeightField = nullptr;
    coTUILabel *showFrameLabel = nullptr;
    coTUILabel *hostLabel = nullptr;
    coTUIEditIntField *showFrameCountField = nullptr;
    coTUIComboBox *selectFormat = nullptr;
    coTUIComboBox *selectFrameRate = nullptr;
    coTUIPopUp *messageBox = nullptr;
    coTUIFileBrowserButton *fileNameBrowser = nullptr;
    coTUIToggleButton *captureAnimButton = nullptr;
    coTUILabel *frameRate = nullptr;
    coTUILabel *cfpsLabel = nullptr;
    coTUIEditFloatField *cfpsEdit = nullptr;
    coTUIToggleButton *captureHostButton[MAX_NUMBER_OF_WINDOWS_OF_SLAVES];
    WINAVIPlugin *sysPlugWinAvi = nullptr;
    FFMPEGPlugin *sysPlugFfmpeg = nullptr;
    SysPlugin *sysPlug = nullptr;
