...
static const int fbx_ps[FBX_FORMATS] = { 3, 4, 3, 4, 4, 4, 1 };
static const int fbx_bgr[FBX_FORMATS] = { 0, 0, 1, 1, 1, 0, 0 };
static const int fbx_alphafirst[FBX_FORMATS] = { 0, 0, 0, 0, 1, 1, 0 };
static const int fbx_roffset[FBX_FORMATS] = { 0, 0, 2, 2, 3, 1, 0 };
static const int fbx_goffset[FBX_FORMATS] = { 1, 1, 1, 1, 2, 2, 0 };
static const int fbx_boffset[FBX_FORMATS] = { 2, 2, 0, 0, 1, 3, 0 };
