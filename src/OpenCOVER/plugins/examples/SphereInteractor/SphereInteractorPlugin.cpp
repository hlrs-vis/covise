...
void
SphereInteractorPlugin::newInteractor(RenderObject *container, coInteractor *i)
{
    (void)container;
    (void)i;
    fprintf(stderr, "SphereInteractorPlugin::newInteractor\n");
}

//-----------------------------------------------------------
void SphereInteractorPlugin::addObject(RenderObject *container,
...
//-----------------------------------------------------------
void
SphereInteractorPlugin::removeObject(const char *objName, bool replace)
{
    (void)objName;
    (void)replace;
