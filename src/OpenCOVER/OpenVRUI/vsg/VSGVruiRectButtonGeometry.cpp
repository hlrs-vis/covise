...
float VSGVruiRectButtonGeometry::A = 0.5f;
float VSGVruiRectButtonGeometry::B = 0.4f;
...
*/
VSGVruiRectButtonGeometry::VSGVruiRectButtonGeometry(coRectButtonGeometry *button)
...
/// Destructor.
VSGVruiRectButtonGeometry::~VSGVruiRectButtonGeometry()
{
    delete myDCS;
    myDCS = 0;
}

void VSGVruiRectButtonGeometry::createSharedLists()
{
   /* if (coord1 == 0)
    {
...
ref_ptr<Node> VSGVruiRectButtonGeometry::createGeode(const string &textureName, int style)
{
  ...
  /*  createSharedLists();
    ...
    {
        VRUILOG("VSGVruiRectButtonGeometry::createBox err: texture image " << textureName << " not found")
    }
...
void VSGVruiRectButtonGeometry::createGeometry()
{
...
void VSGVruiRectButtonGeometry::resizeGeometry()
{
}

vruiTransformNode *VSGVruiRectButtonGeometry::getDCS()
{
    createGeometry();
    return myDCS;
}

void VSGVruiRectButtonGeometry::switchGeometry(coButtonGeometry::ActiveGeometry active)
{
    createGeometry();
