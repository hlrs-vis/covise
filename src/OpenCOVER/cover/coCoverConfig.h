...
public:
    ...
    static bool getWindowConfigEntry(int pos, std::string &name, int *pipeNum, int *ox, int *oy, int *sx, int *sy, bool *decoration = 0, bool *stereo = 0, bool *resize = 0, bool *embedded = 0);
};
}
#endif
