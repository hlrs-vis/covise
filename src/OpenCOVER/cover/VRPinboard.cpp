...
VRPinboard::VRPinboard()
{
    ...
    addFunction("ResetView", BTYPE_FUNC, "reset view", NULL, VRSceneGraph::resetviewCallback, VRSceneGraph::instance());
    ...
    addFunction("XFormTranslate", BTYPE_NAVGROUP, "move world trans", "navigation", coVRNavigationManager::xformTranslateCallback, coVRNavigationManager::instance());
    addFunction("XFormRotate", BTYPE_NAVGROUP, "move world rot", "navigation", coVRNavigationManager::xformRotateCallback, coVRNavigationManager::instance());
    ...
    addFunction("Selection", BTYPE_NAVGROUP, "selection", "view options", coVRSelectionManager::selectionCallback, coVRSelectionManager::instance());
    ...
    addFunction("ReloadVRML", BTYPE_FUNC, "reload VRML", "misc", VRSceneGraph::reloadFileCallback, VRSceneGraph::instance());
    addFunction("Quit", BTYPE_FUNC, "quit", NULL, VRPinboard::quitCallback, OpenCOVER::instance());
