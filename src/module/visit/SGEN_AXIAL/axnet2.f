...
c Gebiet 4
     ...
     #  f(iyb1+bord+ase(1,1)+ase(2,1)+ase(3,1)))
       ...
       asespl=ase(1,1)+ase(2,1)+ase(3,1)+ase(4,1)
...
c     #  aint(bgs),1,1./lvs1,m-1,ase1,f(ixb2+bord),f(iyb2+bord))
     ...
     #   0,ase1-1,aint(bgs),asespl,ase1-1,
...
c ----------------------------------------------------------------------
      ...
      subroutine SPLINEVERSCHIEBUNG(XK,YK,PA,PE,VT,N,NL,XS,YS)
...
c      
      ...
      alpha=atan2((y(s)-y(s-1)),(x(s)-x(s-1)))
