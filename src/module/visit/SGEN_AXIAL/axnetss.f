...
c      
      ase(12,1)=dat10
      ase(12,2)=dat9-dat10+1
c
      ase(13,1)=dat7+dat10+1
      ase(13,2)=dat9-dat10+1
c
      ase(14,1)=dat10
      ase(14,2)=dat7+dat10+1
c
...
c Rand 1   
     ...
     #  0.,2,lvs1,m-1,ase1,f(ixb1+bord),f(iyb1+bord))
c Rand 2       
       call MESHSEED(f(ixp),f(iyp),0,0.,0.,PG(1),PG(2),delta,0.,
     #  aint(bgs),2,lvs1,m-1,ase1,f(ixb2+bord),f(iyb2+bord))
c Vernetzen      
     ...
     #   ase2,1,bvs1,f(ixr+seed),f(iyr+seed))
       ...
       print*,'ixb1, iyb1',ixb1+bord,iyb1+bord
       bord=ase1+bord
...
c Rand 1       
     ...
     #  0.,1,lvs2,m-1,ase1,f(ixb1+bord),f(iyb1+bord))
c Rand 2       
       call MESHSEED(f(ixp),f(iyp),0,0.,0.,PG(2),PG(3),delta,0.,
     #  aint(bgs),1,lvs2,m-1,ase1,f(ixb2+bord),f(iyb2+bord))
c Vernetzen      
       do za=bord,ase1-1+bord,1
        call GERADE(f(ixb2+za),f(iyb2+za),f(ixb1+za),f(iyb1+za),
     #   ase2,1,bvs1,f(ixr+seed),f(iyr+seed))
...
c Rand 1       
     ...
     #  2,lvs4,m-1,ase1,f(ixb1+bord),f(iyb1+bord))
c Rand 2       
       call MESHSEED(f(ixp),f(iyp),0,0.,0.,PG(4),PG(5),0.,0.,aint(bgs),
     #  2,lvs4,m-1,ase1,f(ixb2+bord),f(iyb2+bord))
c Vernetzen      
       do za=bord,ase1-1+bord,1
        call GERADE(f(ixb2+za),f(iyb2+za),f(ixb1+za),f(iyb1+za),
     #   ase2,1,bvs1,f(ixr+seed),f(iyr+seed))
...
c Rand 1       
       ...
       call GERADE(hilf1,yo,hilf2,yo,ase2,2,bvs2,f(ixb1+bord),
     #  f(iyb1+bord))
c Rand 2       
       pob=ase(1,1)
       hilf1=f(ixb2+pob)
       ...
       hilf3=f(ixb2+pob)
       hilf4=f(iyb2+pob)
       print*,hilf1,hilf2,hilf3,hilf4
       call GERADE(hilf1,hilf2,hilf3,hilf4,ase2,
     #  2,bvs2,f(ixb2+bord),f(iyb2+bord))
c Rand 3
       pob=bord
       do za=bord,ase2-1+bord,1
       call GERADE(f(ixb2+za),f(iyb2+za),f(ixb1+za),f(iyb1+za),
     #  ase1,1,lvs7,f(ixr+seed),f(iyr+seed))
        seed=seed+ase1
       end do
       bord=ase1+bord
...
c Rand 1       
       ...
       print*,hilf1,f(ixb2),f(iyb2)
       hilf2=f(ixb2)
       hilf3=f(iyb2)
       print*,hilf2,hilf3,hilf1
...
c       
c       do za=bord,ase1-1+bord,1
c        call GERADE(f(ixb1+za),f(iyb1+za),f(ixb2+za),f(iyb2+za),
c     #   ase2,1,bvs3,f(ixr+seed),f(iyr+seed))
c        seed=seed+ase2
c       end do 
c       bord=ase1+bord 
      print*, 'Gebiet 10 OK !'
...
c     #  d_bord2)) then
     ...
     #   ,bord,d_bord,bord2,d_bord2,seed,d_seed
       ...
       print*,bord,d_bord,bord2,d_bord2,seed,d_seed
c ----------------------------------------------------------------------
...
c
      ...
      read(14,'(T31,I3)',ERR=1) dat8
      read(14,'(T31,I3)',ERR=1) dat9
      read(14,'(T31,I3)',ERR=1) dat10
      read(14,'(T41,F5.3)',ERR=1) lvs1 
      read(14,'(T47,F5.3)',ERR=1) lvs2 
      read(14,'(T49,F5.3)',ERR=1) lvs3 
      read(14,'(T41,F5.3)',ERR=1) lvs4 
