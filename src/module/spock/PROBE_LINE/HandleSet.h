...
public:
    void Compute(int, char **, int, char **);
    void copy_attributes(coDistributedObject *, coDistributedObject *);
    virtual coDistributedObject **ComputeObject(coDistributedObject **, char **, int, int);
    virtual void Compute_No_Output(coDistributedObject **, int);
};
