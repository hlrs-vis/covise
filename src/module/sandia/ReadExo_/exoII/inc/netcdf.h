 ...
 *
 */
/* "$Id: netcdf.h.in,v 1.3 1994/10/05 17:08:43 mksmith Exp $" */
 ...
 */
#define MAX_NC_DIMS 8192 /* max dimensions per file */
#define MAX_NC_ATTRS 128 /* max global or per variable attributes */
#define MAX_NC_VARS 8192 /* max variables per file */
#define MAX_NC_NAME 128 /* max length of a name */
#define MAX_VAR_DIMS 8 /* max per variable dimensions */
/* las
