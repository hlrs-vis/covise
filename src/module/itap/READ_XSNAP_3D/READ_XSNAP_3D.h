...
#ifndef _READ_XSNAP_3D_H
#define _READ_XSNAP_3D_H
...
public:
    ...
    {
        Covise::set_module_description("READ_XSNAP_3D");
        ...
        Covise::set_port_default("datapath", "/mnt/mit/ext/pr/lka11112/mkarb/VIS/_xsnap.H@");

        Covise::add_port(PARIN, "n1_n2_n3", "Vector", "...Grid size");
        Covise::set_port_default("n1_n2_n3", "100 200 200");
        ...
        Covise::set_port_default("d1_d2_d3", "2 2 2");
