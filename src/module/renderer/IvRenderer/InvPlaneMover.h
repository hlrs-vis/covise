...
public:
    ...
    InvPlaneMover(InvCoviseViewer *v);
...
private:
    ...
    InvPlaneMover(const InvPlaneMover &p)
    {
        (void)p;
        cerr << "ERROR: InvPlaneMover copy-constructor called" << endl;
    };
    const InvPlaneMover &operator=(const InvPlaneMover &p)
    {
        return p;
    }
