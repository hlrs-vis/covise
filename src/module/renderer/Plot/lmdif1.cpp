...
/* $Id: lmdif1.c,v 1.4 1994/08/08 04:52:54 pturner Exp pturner $
 *
...
extern int curset; /* used in the call to scanner() */

int fcn_(integer *m, integer *n, doublereal *x, doublereal *fvec, integer *iflag);
...
int lmdif1_(int (*fcn)(integer *m, integer *n, doublereal *x, doublereal *fvec, integer *iflag), int *, int *,
            doublereal *x, doublereal *fvec, doublereal *tol,
            int *, int *, doublereal *wa, int *);
         ...
         integer *iflag)
{
    ...
    strcpy(val, func);
    fixupstr(val);
    scanner(val, xp, yp, (int)*m, ax, bx, cx, dx, 1, 0, curset, &errpos);
    if (errpos)
    {
...
int lmdif1_(int (*fcn)(integer *m, integer *n, doublereal *x, doublereal *fvec, integer *iflag), int *m, int *n,
            doublereal *x, doublereal *fvec, doublereal *tol,
            int *info, int *iwa, doublereal *wa, int *lwa)
{
    /* Initialized data */
    ...
    *info = 0;
    ...
    nprint = 0;
    mp5n = *m + *n * 5;
    lmdif_(fcn, (integer *)m, (integer *)n, &x[1], &fvec[1], &ftol, &xtol, &gtol, &maxfev, &epsfcn,
           &wa[1], &mode, &factor, &nprint, (integer *)info, &nfev, &wa[mp5n + 1], (integer *)m, (integer *)&iwa[1], &wa[*n + 1], &wa[(*n << 1) + 1], &wa[*n * 3 + 1], &wa[(*n
                                                                                                                                                                            << 2) + 1],
           &wa[*n * 5 + 1]);
    if (*info == 8)
    {
...
int lmdif_(int (*fcn)(integer *m, integer *n, doublereal *x, doublereal *fvec, integer *iflag), integer *m, integer *n,
           doublereal *x, doublereal *fvec, doublereal *ftol,
           doublereal *xtol, doublereal *gtol, integer *maxfev,
           doublereal *epsfcn, doublereal *diag, integer *mode,
           doublereal *factor, integer *nprint, integer *info,
           integer *nfev, doublereal *fjac, integer *ldfjac,
...
/* Subroutine */
{
    ...
    extern /* Subroutine */ int qrfac_(integer * m, integer * n, doublereal * a, integer * lda, logical * pivot, integer * ipvt, integer * lipvt, doublereal * rdiag, doublereal * acnorm, doublereal * wa), lmpar_(integer * n, doublereal * r, integer * ldr, integer * ipvt, doublereal * diag, doublereal * qtb, doublereal * delta, doublereal * par, doublereal * x, doublereal * sdiag, doublereal * wa1, doublereal * wa2);
    static doublereal ratio;
    extern doublereal enorm_(integer * n, doublereal * x);
    static doublereal fnorm, gnorm;
    extern /* Subroutine */ int fdjac2_(int (*fcn)(integer *m, integer *n, doublereal *x, doublereal *fvec, integer *iflag), integer *m, integer *n, doublereal *x, doublereal *fvec, doublereal *fjac, integer *ldfjac, integer *iflag, doublereal *epsfcn, doublereal *wa);
    static doublereal pnorm, xnorm, fnorm1, actred, dirder, epsmch, prered;
    extern doublereal dpmpar_(integer * i);
...
L40:
    ...
    qrfac_(m, n, &fjac[fjac_offset], ldfjac, &c__1, &ipvt[1], n, &wa1[1], &wa2[1], &wa3[1]);
...
/* Subroutine */ int lmpar_(integer *n, doublereal *r, integer *ldr, integer *ipvt, doublereal *diag, doublereal *qtb, doublereal *delta, doublereal *par, doublereal *x, doublereal *sdiag, doublereal *wa1, doublereal *wa2)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int qrsolv_(integer * n, doublereal * r, integer * ldr, integer * ipvt, doublereal * diag, doublereal * qtb, doublereal * x, doublereal * sdiag, doublereal * wa);
...
/* Subroutine */ int qrsolv_(integer *n, doublereal *r, integer *ldr, integer *ipvt, doublereal *diag, doublereal *qtb, doublereal *x, doublereal *sdiag, doublereal *wa)
{
    /* Initialized data */
...
/* Subroutine */ int qrfac_(integer *m, integer *n, doublereal *a, integer *lda, logical *pivot, integer *ipvt, integer *, doublereal *rdiag, doublereal *acnorm, doublereal *wa)
{
    /* Initialized data */
...
/* Subroutine */ int fdjac2_(int (*fcn)(integer *m, integer *n, doublereal *x, doublereal *fvec, integer *iflag), integer *m, integer *n, doublereal *x, doublereal *fvec, doublereal *fjac, integer *ldfjac, integer *iflag, doublereal *epsfcn, doublereal *wa)
/* Subroutine */
