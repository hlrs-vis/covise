		...
		if (fp)
		{
			...
			else if (outputMode == OutputMode::X3DOM)
			{
                ...
                <!DOCTYPE html>\n\
                    ...
                    <td align = 'left'>", fp);
				//add checkbox for every variant and count the timesteps
				...
				fprintf(fp, "</td>\n\
                    ...
                    <br>\n\
                    0\n\
                    <input type = 'range' id = 'TimestepSlider' min = '-1' max = '%i' step = '1' value = '0' onchange = 'changeVisibleTimestep(this.value)'/>\n\
                    <br>\n\
