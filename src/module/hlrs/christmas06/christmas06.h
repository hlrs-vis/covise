...
class christmas06 : public coModule
{
...
#define GEO_SEC "GeometrySection"
    ...
    int GetParamsFromControlPanel(struct christ_model *model);
    int setGeoParamsStandardForChristMas06();

public:
    christmas06(int argc, char *argv[]);
};
