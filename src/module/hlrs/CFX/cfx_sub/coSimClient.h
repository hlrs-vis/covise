...
/* these includes should be here and not in coSimClient.c!*/
...
// Covise Simulation Library, Simulation side
//
...
/* Read a 3D vector Parameter of the module */
/* Fortran 77: COGVFL() */
...
int coSend1Data(const char *portName, int numElem,
                float *data); /* Fortran 77: COSU1D */

/* Send an USG vector data field */
int coSend3Data(const char *portName, int numElem, float *data0,
                float *data1, float *data2); /* Fortran 77: COSU3D */
...
/* detach and attach covise to running simulation */
int coDetach(void); /* Fortran 77: DETACH */
int coAttach(void); /* Fortran 77: ATTACH */
