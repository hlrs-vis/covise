...
export CFX5_UNITS_DIR=/mnt/raid/soft/linux/CFX/v11.0sp1/ansys_inc/v110/CFX/etc
export CFX_HOME=/mnt/raid/soft/linux/CFX/v11.0sp1
export PATH=$CFX_HOME/ansys_inc/v110/CFX/bin:$PATH
export LD_LIBRARY_PATH=$CFX_HOME/ansys_inc/v110/CFX/tools/mpich-1.2.6-1/Linux-amd64/lib/shared:$LD_LIBRARY_PATH
...
echo "cfx.sh: CO_SIMLIB_CONN: $CO_SIMLIB_CONN"

CFXDIR=$HOME/covise/src/application/hlrs/CFX

killall /mnt/raid/soft/linux/CFX/v11.0sp1/ansys_inc/v110/CFX/bin/cfx5solve
...
if [ "$machineType" == "radial" ] || [ "$machineType" == "axial" ] || [ "$machineType" == "rechenraum" ] || [ "$machineType" == "surfacedemo" ]; then
...
if [ "$deffile" == "0" ]; then
   ...
   #echo executing cfx5pre $CFXDIR/$concat2
   #cfx5pre $CFXDIR/$concat2
