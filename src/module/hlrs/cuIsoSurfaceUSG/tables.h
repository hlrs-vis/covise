...
static uint tetraTriTable[16][6] = {
    { X, X, X, X, X, X }, //0
    { 0, 1, 2, X, X, X }, //1
    { 0, 4, 3, X, X, X }, //2
    { 2, 1, 4, 4, 3, 1 }, //3
...
static uint pyrNumVertsTable[32] = {
    0,
    3,
    3,
    6,
...
static uint pyrTriTable[32][12] = {
    { X, X, X, X, X, X, X, X, X, X, X, X },
    { 0, 4, 1, X, X, X, X, X, X, X, X, X },
    { 0, 2, 5, X, X, X, X, X, X, X, X, X },
    { 2, 4, 1, 5, 4, 2, X, X, X, X, X, X },
    { 1, 6, 3, X, X, X, X, X, X, X, X, X },
    { 3, 0, 4, 6, 3, 4, X, X, X, X, X, X },
    { 3, 2, 5, 6, 3, 5, 6, 5, 1, 1, 5, 0 },
    { 2, 5, 3, 5, 6, 3, 5, 4, 6, X, X, X },
    { 2, 3, 7, X, X, X, X, X, X, X, X, X },
    { 3, 4, 1, 7, 4, 3, 7, 2, 4, 2, 0, 4 },
    { 3, 5, 0, 7, 5, 3, X, X, X, X, X, X },
    { 1, 3, 4, 3, 7, 4, 5, 4, 7, X, X, X },
    { 2, 1, 6, 7, 2, 6, X, X, X, X, X, X },
    { 0, 4, 2, 2, 4, 7, 6, 7, 4, X, X, X },
    { 1, 5, 0, 6, 5, 1, 6, 7, 5, X, X, X },
    { 5, 6, 7, 5, 4, 6, X, X, X, X, X, X },
    { 4, 5, 6, 7, 6, 5, X, X, X, X, X, X },
    { 7, 1, 0, 5, 7, 0, 6, 1, 7, X, X, X },
    { 6, 0, 2, 4, 0, 6, 7, 6, 2, X, X, X },
    { 2, 7, 6, 2, 6, 1, X, X, X, X, X, X },
    { 5, 3, 1, 4, 5, 1, 7, 3, 5, X, X, X },
    { 3, 5, 7, 3, 0, 5, X, X, X, X, X, X },
    { 3, 2, 7, 1, 4, 0, X, X, X, X, X, X },
    { 2, 7, 3, X, X, X, X, X, X, X, X, X },
    { 4, 2, 3, 5, 2, 4, 6, 4, 3, X, X, X },
    { 3, 6, 1, 2, 0, 5, X, X, X, X, X, X },
    { 3, 6, 4, 3, 4, 0, X, X, X, X, X, X },
    { 1, 3, 6, X, X, X, X, X, X, X, X, X },
    { 2, 4, 5, 2, 1, 4, X, X, X, X, X, X },
    { 0, 5, 2, X, X, X, X, X, X, X, X, X },
