...
#ifndef _EDGE_COLLAPSE_SIMPLE_H_
#define _EDGE_COLLAPSE_SIMPLE_H_

#include "EdgeCollapseBasis.h"

class EdgeCollapseSimple : public EdgeCollapseBasis
{
public:
    EdgeCollapseSimple(
        const vector<float> &x_c,
