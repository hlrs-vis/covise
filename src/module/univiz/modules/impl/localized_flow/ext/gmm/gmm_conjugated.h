...
struct conjugated_const_iterator
{
    ...
    conjugated_const_iterator(const IT &i)
        : it(i)
    {
    }
    ...
    {
        conjugated_const_iterator tmp = *this;
        ++it;
        return tmp;
    }
    conjugated_const_iterator operator--(int)
    ...
    conjugated_const_iterator &operator++()
    {
        ++it;
        return *this;
    }
    ...
    {
        conjugated_const_iterator itb = *this;
        return (itb += i);
    }
    conjugated_const_iterator operator-(difference_type i) const
    {
...
struct conjugated_vector_const_ref
{
    ...
    conjugated_vector_const_ref(const V &v)
        : begin_(vect_const_begin(v))
        , end_(vect_const_end(v))
...
struct linalg_traits<conjugated_vector_const_ref<V> >
{
    ...
    typedef conjugated_const_iterator<typename linalg_traits<V>::const_iterator> const_iterator;
...
template <typename V>
std::ostream &operator<<(std::ostream &o, const conjugated_vector_const_ref<V> &m)
{
    gmm::write(o, m);
    return o;
}
...
struct conjugated_row_const_iterator
{
    ...
    conjugated_row_const_iterator(const ITER &i)
        : it(i)
    {
    }
};
...
template <typename M>
std::ostream &operator<<(std::ostream &o, const conjugated_row_matrix_const_ref<M> &m)
{
    gmm::write(o, m);
    return o;
}
...
struct conjugated_col_const_iterator
{
    ...
    conjugated_col_const_iterator(const ITER &i)
        : it(i)
    {
    }
};
...
template <typename M>
std::ostream &operator<<(std::ostream &o, const conjugated_col_matrix_const_ref<M> &m)
{
    gmm::write(o, m);
    return o;
}

template <typename L, typename SO>
...
template <typename L, typename T, typename LT>
...
{
    typedef typename conjugated_return_<L, typename linalg_traits<L>::value_type,
                                        typename linalg_traits<L>::linalg_type>::return_type return_type;
};

template <typename L>
inline typename conjugated_return<L>::return_type
...
template <typename L, typename T, typename LT>
inline const L &conjugated(const L &v, T, LT)
{
    return v;
}

template <typename L, typename T>
inline conjugated_vector_const_ref<L> conjugated(const L &v, std::complex<T>,
                                                 abstract_vector)
{
...
template <typename L, typename T>
inline typename conjugated_return__<L,
                                    typename principal_orientation_type<typename linalg_traits<L>::sub_orientation>::potype>::return_type
conjugated(const L &v, T, abstract_matrix)
{
    return conjugated(v, typename principal_orientation_type<typename linalg_traits<L>::sub_orientation>::potype());
}

template <typename L>
inline conjugated_row_matrix_const_ref<L> conjugated(const L &v, row_major)
{
    return conjugated_row_matrix_const_ref<L>(v);
}

template <typename L>
inline conjugated_col_matrix_const_ref<L> conjugated(const L &v, col_major)
{
