...
public:
    ...
    tab_ref(const ITER &b, const ITER &e)
        : begin_(b)
        , end_(e)
    {
    }
...
public:
    ...
    const COND &condition(void) const
    {
        return cond;
    }
