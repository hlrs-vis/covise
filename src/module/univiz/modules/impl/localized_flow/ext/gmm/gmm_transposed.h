...
struct linalg_traits<transposed_row_ref<PT> >
{
    ...
    typedef typename select_ref<abstract_null_type, typename linalg_traits<M>::sub_row_type, PT>::ref_type sub_col_type;
    typedef typename linalg_traits<M>::const_row_iterator const_col_iterator;
    typedef typename select_ref<abstract_null_type, typename linalg_traits<M>::row_iterator, PT>::ref_type col_iterator;
...
template <typename PT>
std::ostream &operator<<(std::ostream &o, const transposed_row_ref<PT> &m)
{
    gmm::write(o, m);
    return o;
}
...
struct linalg_traits<transposed_col_ref<PT> >
{
    ...
    typedef typename select_ref<abstract_null_type, typename linalg_traits<M>::sub_col_type, PT>::ref_type sub_row_type;
    typedef typename linalg_traits<M>::const_col_iterator const_row_iterator;
    typedef typename select_ref<abstract_null_type, typename linalg_traits<M>::col_iterator, PT>::ref_type row_iterator;
...
template <typename PT>
std::ostream &operator<<(std::ostream &o, const transposed_col_ref<PT> &m)
{
    gmm::write(o, m);
    return o;
}

template <typename TYPE, typename PT>
...
{
    typedef typename std::iterator_traits<PT>::value_type L;
    typedef typename transposed_return_<typename principal_orientation_type<typename linalg_traits<L>::sub_orientation>::potype,
                                        PT>::return_type return_type;
};

template <typename L>
inline typename transposed_return<const L *>::return_type transposed(const L &l)
{
    return typename transposed_return<const L *>::return_type(linalg_cast(const_cast<L &>(l)));
}

template <typename L>
inline typename transposed_return<L *>::return_type transposed(L &l)
{
