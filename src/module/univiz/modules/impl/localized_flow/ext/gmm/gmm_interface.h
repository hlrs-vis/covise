...
template <typename IT, typename ORG, typename PT>
inline void set_to_begin(IT &it, ORG o, simple_vector_ref<PT> *, linalg_modifiable)
{
...
template <typename IT, typename ORG, typename PT>
inline void set_to_begin(IT &it, ORG o, const simple_vector_ref<PT> *,
                         linalg_modifiable)
{
    typedef typename linalg_traits<simple_vector_ref<PT> >::V_reference ref_t;
    set_to_begin(it, o, PT(), ref_t());
...
template <typename IT, typename ORG, typename PT>
inline void set_to_end(IT &it, ORG o, simple_vector_ref<PT> *, linalg_modifiable)
{
    typedef typename linalg_traits<simple_vector_ref<PT> >::V_reference ref_t;
...
template <typename IT, typename ORG, typename PT>
inline void set_to_end(IT &it, ORG o, const simple_vector_ref<PT> *,
                       linalg_modifiable)
{
    typedef typename linalg_traits<simple_vector_ref<PT> >::V_reference ref_t;
    set_to_end(it, o, PT(), ref_t());
...
{
template <typename T>
ostream &operator<<(std::ostream &o, const vector<T> &m)
{
    gmm::write(o, m);
    return o;
}
...
template <typename T>
inline size_type nnz(const std::vector<T> &l)
{
    return l.size();
}
...
template <typename IT, typename V>
std::ostream &operator<<(std::ostream &o, const tab_ref_with_origin<IT, V> &m)
{
    gmm::write(o, m);
    return o;
}
...
struct tab_ref_reg_spaced_with_origin : public dal::tab_ref_reg_spaced<IT>
{
    ...
    tab_ref_reg_spaced_with_origin(const IT &b, const IT &e, size_type n,
        ...
        : dal::tab_ref_reg_spaced<IT>(b, e, n)
        , origin(p)
    {
    }
...
template <typename IT, typename V>
std::ostream &operator<<(std::ostream &o, const tab_ref_reg_spaced_with_origin<IT, V> &m)
{
    gmm::write(o, m);
    return o;
}
    ...
    : public dal::tab_ref_index_ref<IT, ITINDEX>
{
    ...
    tab_ref_index_ref_with_origin(const IT &b, const ITINDEX &bi,
        ...
        : dal::tab_ref_index_ref<IT, ITINDEX>(b, bi, ei)
        , origin(p)
    {
    }
...
template <typename IT, typename ITINDEX, typename V>
std::ostream &operator<<(std::ostream &o, const tab_ref_index_ref_with_origin<IT, ITINDEX, V> &m)
{
    gmm::write(o, m);
    return o;
}
...
struct cs_vector_ref_iterator
{
    ...
    cs_vector_ref_iterator(PT1 p1, PT2 p2)
        : pr(p1)
        , ir(p2)
    {
    }
...
template <typename PT1, typename PT2, int shift>
std::ostream &operator<<(std::ostream &o, const cs_vector_ref<PT1, PT2, shift> &m)
{
    gmm::write(o, m);
    return o;
}
...
template <typename PT1, typename PT2, int shift>
inline size_type nnz(const cs_vector_ref<PT1, PT2, shift> &l)
{
    return l.n;
}
...
template <typename PT1, typename PT2, typename PT3, int shift>
std::ostream &operator<<(std::ostream &o, const csc_matrix_ref<PT1, PT2, PT3, shift> &m)
{
    gmm::write(o, m);
    return o;
}
...
template <typename PT1, typename PT2, typename PT3, int shift>
std::ostream &operator<<(std::ostream &o, const csr_matrix_ref<PT1, PT2, PT3, shift> &m)
{
    gmm::write(o, m);
    return o;
}
