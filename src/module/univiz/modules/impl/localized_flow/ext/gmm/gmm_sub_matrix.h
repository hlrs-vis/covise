...
struct gen_sub_row_matrix
{
    ...
    typedef typename select_ref<typename linalg_traits<M>::const_row_iterator, typename linalg_traits<M>::row_iterator,
...
struct gen_sub_row_matrix_iterator
{
    ...
    gen_sub_row_matrix_iterator(const gen_sub_row_matrix_iterator<MPT, SUBI1, SUBI2> &itm)
        : it(itm.it)
        , si1(itm.si1)
        , si2(itm.si2)
        , ii(itm.ii)
...
struct linalg_traits<gen_sub_row_matrix<PT, SUBI1, SUBI2> >
{
    ...
    typedef typename sub_vector_type<const typename linalg_traits<M>::const_sub_row_type *, SUBI2>::vector_type
        const_sub_row_type;
    typedef typename select_ref<abstract_null_type,
                                typename sub_vector_type<typename linalg_traits<M>::sub_row_type *,
                                                         SUBI2>::vector_type,
                                PT>::ref_type sub_row_type;
...
struct gen_sub_col_matrix
{
    ...
    typedef M *CPT;
    typedef typename std::iterator_traits<PT>::reference ref_M;
    typedef typename select_ref<typename linalg_traits<M>::const_col_iterator, typename linalg_traits<M>::col_iterator,
                                PT>::ref_type iterator;
    typedef typename linalg_traits<this_type>::reference reference;
    typedef typename linalg_traits<this_type>::porigin_type porigin_type;
...
struct gen_sub_col_matrix_iterator
{
    ...
    gen_sub_col_matrix_iterator(const gen_sub_col_matrix_iterator<MPT, SUBI1, SUBI2> &itm)
        : it(itm.it)
        , si1(itm.si1)
        , si2(itm.si2)
        , ii(itm.ii)
...
struct linalg_traits<gen_sub_col_matrix<PT, SUBI1, SUBI2> >
{
    ...
    typedef typename sub_vector_type<const typename linalg_traits<M>::const_sub_col_type *, SUBI1>::vector_type
        const_sub_col_type;
    typedef typename select_ref<abstract_null_type,
                                typename sub_vector_type<typename linalg_traits<M>::sub_col_type *,
                                                         SUBI1>::vector_type,
                                PT>::ref_type sub_col_type;
...
template <typename PT, typename SUBI1, typename SUBI2>
std::ostream &operator<<(std::ostream &o, const gen_sub_col_matrix<PT, SUBI1, SUBI2> &m)
{
    gmm::write(o, m);
    return o;
}
...
struct sub_matrix_type
{
    ...
    typedef typename sub_matrix_type_<PT, SUBI1, SUBI2,
                                      typename principal_orientation_type<typename linalg_traits<M>::sub_orientation>::potype>::matrix_type matrix_type;
};

template <typename M, typename SUBI1, typename SUBI2>
inline typename select_return<typename sub_matrix_type<const M *, SUBI1, SUBI2>::matrix_type, typename sub_matrix_type<M *, SUBI1, SUBI2>::matrix_type,
                              M *>::return_type
sub_matrix(M &m, const SUBI1 &si1, const SUBI2 &si2)
{
    ...
    return typename select_return<typename sub_matrix_type<const M *, SUBI1,
                                                           SUBI2>::matrix_type,
                                  typename sub_matrix_type<M *, SUBI1, SUBI2>::matrix_type, M *>::return_type(linalg_cast(m), si1, si2);
}
...
sub_matrix(const M &m, const SUBI1 &si1, const SUBI2 &si2)
{
    ...
    return typename select_return<typename sub_matrix_type<const M *, SUBI1,
                                                           SUBI2>::matrix_type,
                                  typename sub_matrix_type<M *, SUBI1, SUBI2>::matrix_type, const M *>::return_type(linalg_cast(m), si1, si2);
}

template <typename M, typename SUBI1>
inline typename select_return<typename sub_matrix_type<const M *, SUBI1, SUBI1>::matrix_type, typename sub_matrix_type<M *, SUBI1, SUBI1>::matrix_type,
                              M *>::return_type
sub_matrix(M &m, const SUBI1 &si1)
{
    ...
    return typename select_return<typename sub_matrix_type<const M *, SUBI1,
                                                           SUBI1>::matrix_type,
                                  typename sub_matrix_type<M *, SUBI1, SUBI1>::matrix_type, M *>::return_type(linalg_cast(m), si1, si1);
}
...
sub_matrix(const M &m, const SUBI1 &si1)
{
    ...
    return typename select_return<typename sub_matrix_type<const M *, SUBI1,
                                                           SUBI1>::matrix_type,
                                  typename sub_matrix_type<M *, SUBI1, SUBI1>::matrix_type, const M *>::return_type(linalg_cast(m), si1, si1);
}
}
