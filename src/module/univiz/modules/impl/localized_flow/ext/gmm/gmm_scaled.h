...
struct scaled_const_iterator
{
    ...
    scaled_const_iterator(const IT &i, S x)
        : it(i)
        , r(x)
    {
    }
    ...
    {
        scaled_const_iterator tmp = *this;
        ++it;
        return tmp;
    }
    inline scaled_const_iterator operator--(int)
    ...
    inline scaled_const_iterator &operator++()
    {
        ++it;
        return *this;
    }
    ...
    {
        scaled_const_iterator itb = *this;
        return (itb += i);
    }
    inline scaled_const_iterator operator-(difference_type i) const
    {
    ...
    inline value_type operator[](size_type ii) const
    {
        return it[ii] * r;
    }
...
template <typename V, typename S>
std::ostream &operator<<(std::ostream &o, const scaled_vector_const_ref<V, S> &m)
{
    gmm::write(o, m);
    return o;
}
...
template <typename M, typename S>
std::ostream &operator<<(std::ostream &o, const scaled_row_matrix_const_ref<M, S> &m)
{
    gmm::write(o, m);
    return o;
}
...
template <typename M, typename S>
std::ostream &operator<<(std::ostream &o, const scaled_col_matrix_const_ref<M, S> &m)
{
    gmm::write(o, m);
    return o;
}
...
template <typename L, typename S, typename LT>
...
{
    typedef typename scaled_return_<L, S, typename linalg_traits<L>::linalg_type>::return_type return_type;
};

template <typename L, typename S>
inline typename scaled_return<L, S>::return_type
...
template <typename V, typename S>
inline typename scaled_return<V, S>::return_type
...
template <typename M, typename S>
inline typename scaled_return<M, S>::return_type
scaled(const M &m, S x, abstract_matrix)
{
    return scaled(m, x, typename principal_orientation_type<typename linalg_traits<M>::sub_orientation>::potype());
}
...
template <typename L>
inline void scale(L &l, typename linalg_traits<L>::value_type a)
{
    scale(l, a, typename linalg_traits<L>::linalg_type());
}

template <typename L>
inline void scale(const L &l, typename linalg_traits<L>::value_type a)
{
    scale(linalg_const_cast(l), a);
}

template <typename L>
inline void scale(L &l, typename linalg_traits<L>::value_type a, abstract_vector)
{
...
{
    scale(l, a, typename principal_orientation_type<typename linalg_traits<L>::sub_orientation>::potype());
}
...
void scale(L &l, typename linalg_traits<L>::value_type a, row_major)
{
    typename linalg_traits<L>::row_iterator it = mat_row_begin(l),
                                            ite = mat_row_end(l);
    for (; it != ite; ++it)
        scale(linalg_traits<L>::row(it), a);
}
...
void scale(L &l, typename linalg_traits<L>::value_type a, col_major)
{
    typename linalg_traits<L>::col_iterator it = mat_col_begin(l),
                                            ite = mat_col_end(l);
    for (; it != ite; ++it)
        scale(linalg_traits<L>::col(it), a);
}
}
