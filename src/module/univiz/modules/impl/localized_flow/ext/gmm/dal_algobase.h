...
template <>
struct less<int> : public std::binary_function<int, int, int>
{
...
template <>
struct less<char> : public std::binary_function<char, char, int>
{
...
template <>
struct less<short> : public std::binary_function<short, short, int>
{
    int operator()(short x, short y) const
    {
        return int(x - y);
    }
};
template <>
struct less<unsigned char> : public std::binary_function<unsigned char, unsigned char, int>
{
...
template <>
struct greater<int> : public std::binary_function<int, int, int>
{
    int operator()(int x, int y) const
    {
        return y - x;
...
template <>
struct greater<char> : public std::binary_function<char, char, int>
{
    int operator()(char x, char y) const
    {
        return int(y - x);
...
template <>
struct greater<short> : public std::binary_function<short, short, int>
{
    int operator()(short x, short y) const
    {
        return int(y - x);
...
template <>
struct greater<unsigned char> : public std::binary_function<unsigned char, unsigned char, int>
{
    int operator()(unsigned char x, unsigned char y) const
    {
        return int(y) - int(x);
...
struct lexicographical_less : public std::binary_function<CONT, CONT, int>
{
    ...
    lexicographical_less(const COMP &d = COMP())
    {
        c = d;
    }
};
    ...
    : public std::binary_function<CONT, CONT, int>
{
    ...
    lexicographical_greater(const COMP &d = COMP())
    {
        c = d;
    }
};
...
{
    if (first == last)
        DAL_INTERNAL_ERROR("mean value of empty container");
    size_t n = 1;
...
public:
    sorted_indexes_aux(const VEC &v_)
        : v(v_)
    {
    }
