...
C                                           E. Goede  H824,  24. 2. 94
   ...
   10 FORMAT (1X, 'Dieses File enthaelt die Profilkoordinaten der ',
     .           'Laufschaufel gut verteilt')
   20 FORMAT (1X, '-----------------------------------------------',
     .           '------', /)
   30 FORMAT (1X, 'Anzahl Profile: ', /, I5)
   40 FORMAT (1X, 'Anzahl Punkte pro Profil: ', /, I5, /)
   50 FORMAT (1X, '***** Die Profilkoordinaten laufen von HK DS --> HK '
     .            ,'SS *****')
   60 FORMAT (/, 1X, 'Profil ', I2, /)
   70 FORMAT (1X, '  X [mm]     Y [mm]     Z [mm] ', /)
...
C                                           E. Goede  IHS,  24. 10. 95
   ...
   10 FORMAT (1X, 'Dieses File enthaelt die Koordinaten des Kanals ',
     .           ' - zunaechst - ')
   20 FORMAT (1X, '------------------------------------------------',
     .           '---------------', /)
   30 FORMAT (1X, 'Anzahl Profile: ', /, I5, /)
   40 FORMAT (/, 1X, 'Anzahl Punkte pro Kanalkontur: ', /, I5, /)
   50 FORMAT (1X, '***** Die Profilkoordinaten laufen von HK DS --> HK '
     .            ,'SS *****' )
   60 FORMAT (/, 1X, 'Profil ', I2, /)
   70 FORMAT (1X, '  X [mm]     Y [mm]     Z [mm] ', /)
   80 FORMAT (3(3X, F10.3))
  110 FORMAT (1X, 'Schaufel-Vorderkante  Z [mm]   R [mm] ') 
  120 FORMAT (/, 1X, 'Schaufel-Hinterkante ZDS [mm]  RDS [mm] ',
     .           ' ZSS [mm]  RSS [mm] ') 
  130 FORMAT (1X, 'Meridiankontur, Nabe u. Kranz  ')
...
C                                           E. Goede  IHS,  22. 9. 96
   ...
   50 FORMAT(4X,F8.3,1X,F8.3,1X,F8.3,1X,F8.3,1X,F8.3,1X,F8.3)
      ...
      open (20,file=datei_zwischen_prof,status='unknown')
...
C                                           E. Goede  IHS,  4. 10. 96
   ...
   50 FORMAT(4X,F8.3,1X,F8.3,1X,F8.3,1X,F8.3,1X,F8.3,1X,F8.3)
      ...
      open (20,file=datei_Batrekhy_prof,status='unknown')
