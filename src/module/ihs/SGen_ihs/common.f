      INTEGER NPANZ, NPROF, NPMAX, NECKM, NKANT, anznk
     ...
     .         ZUSPITZEN, EX 
      INTEGER lesenok   
      REAL      theta_sch, theta_p, theta_s
     ...
     *     ZHKDS(NPANZ), RHKDS(NPANZ), ZHKSS(NPANZ), RHKSS(NPANZ)
     ...
     .      delta_beta1, delta_beta2, d_2
      REAL  DL_basprof, XL_basprof, profmax
      REAL  DL_prof, XL_prof
      REAL  XWRL, BETA1, BETA2, DS, AL, Z, dzul, sdpktzul
      REAL  dzul_r, d_theta2, d_theta1
      REAL  d2, di_da, n_z2, D1, D2Z, z_axe_la
      REAL  r_nabe, z_nabe
      REAL  r_kranz, z_kranz
