...
C    +----------------------------------------------------------------------+
C    I                                                                      I
C    I    Berechnung der Hinterkantendicken                                 I
C    I                                                                      I
C    +----------------------------------------------------------------------+
C                                           A. Kaps  IHS,   7. 00

      SUBROUTINE RECHNE_HINTERKANTE
	 ...
	 do j=1,Nprofile       
          ...
          hk_dicke = hk_dicke_i
     #             + (hk_dicke_a-hk_dicke_i) * (j-1)/(Nprofile-1)

              	 do i=1,ZDP              

	            DL_prof(j,i) = DL_prof(j,i)
     #                           + hk_dicke * XL_prof(j,i)/100.
