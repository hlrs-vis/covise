...
#define COARSEN_FRACTION   0.75f                   /* Node reduction between succesive coarsening levels */
#define COARSEN_FRACTION2  0.90f                  /* Node reduction between succesive coarsening levels */
#define UNBALANCE_FRACTION    1.05f

#define COMPRESSION_FRACTION     0.85f

#define ORDER_UNBALANCE_FRACTION 1.10f

#define MMDSWITCH    200

#define HORIZONTAL_IMBALANCE     1.05f
