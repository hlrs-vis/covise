                          ...
                          float *tpwgts, int *options, int *edgecut, idxtype *part)
{
  ...
  *edgecut = MlevelKWayPartitioning(&ctrl, &graph, *nparts, part, tpwgts, 1.03f);
           ...
           idxtype *adjwgt, int *options, int *sepsize, idxtype *part) 
{
  ...
  MlevelNodeBisectionMultiple(&ctrl, &graph, tpwgts, 1.05f);
           ...
           idxtype *adjwgt, int *options, int *sepsize, idxtype *part) 
{
  ...
  MlevelEdgeBisection(&ctrl, &graph, tpwgts, 1.05f);
  ConstructMinCoverSeparator(&ctrl, &graph, 1.05f);
