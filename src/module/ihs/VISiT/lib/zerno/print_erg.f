...
C **************************************************************
C **************************************************************
      SUBROUTINE PRINT_ERG(lnods_num,coord_num,
     *                     kern_kn,kern_kn_adr,
     *                     lapp_kn,lapp_kn_adr,
     *                     dopp_kn,dopp_kn_adr,
     *                     kern_el,kern_el_adr,
     ...
     *        ip1,ip2,ip3,ip4
      ...
      character*80 file_name,erg_name,erg_pfad,comment,
     *             form_node,form_elem
...
c     GEBIETSWEISER AUSDRUCK DER ANFANGSNAEHERUNG: 
      ...
      do 100 igeb=1,ngebiet
         ...
         write(lu,*)'#                                      '
         write(lu,*)'#                                      '
         call char_druck(comment,erg_name,lu)
         write(lu,*)'#                                      '
         write(lu,*)'#                                      '
         write(lu,*)'#                                      '
         write(lu,*)'#                                      '
...
c     FEHLERMELDUNG FUER FALSCH GEOEFFNETE FILES:
      ...
      goto 888
 777  continue      
      comment='Fehler beim Oeffnen von File (print_erg):'
