...
coDistributedObject **Surface::createcoDistributedObjects(int red_tri, int red_points, char *Triangle_name, char *Data_name, char *Normals_name)
{
...
int Surface::make_link(int v1, int v2, Star star, pair *link, int &num_link)
{
    int i, j;
...
int Surface::Least_Square(double (*A)[MAXTRI], double *d, double *x, int m, int n)
...
float Surface::compute_star_volume(int v1, int v2, Star star, pair *link, int num_link, float x0, float y0, float z0)
