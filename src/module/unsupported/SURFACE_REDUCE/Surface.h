...
protected:
    ...
    int make_link(int v1, int v2, Star star, pair *link, int &num_link);
    ...
    float compute_tetra_volume(int v1, int v2, int v3, float x0, float y0, float z0);
    float compute_tetra_volume(int t, float x0, float y0, float z0);
    float compute_inner_angle(int v1, int v, int v2);
    float compute_star_volume(int v, int num_link, triple *retri);
    float compute_star_volume(int v1, int v2, Star star, pair *link, int num_link, float x_0, float y_0, float z_0);
...
public:
    Surface(){};
    Surface(int n_points, int n_vert, int n_poly, char *mesh_type, int *pl, int *vl, float *x_in, float *y_in, float *z_in, float *nu_in, float *nv_in, float *nw_in);
    virtual ~Surface()
    {
        int i;
    ...
    virtual coDistributedObject **createcoDistributedObjects(int red_tri, int red_points, char *Triangle_name, char *Data_name, char *Normals_name);
};
#endif // _SURFACE_H
