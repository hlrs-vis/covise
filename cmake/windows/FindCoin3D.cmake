...
ELSE (WIN32)
  IF(APPLE)
    FIND_PATH(COIN3D_INCLUDE_DIRS So.h
      PATHS
      $ENV{EXTERNLIBS}/Inventor.framework/Headers
      /Library/Frameworks/Inventor.framework/Headers 
    )
    FIND_LIBRARY(COIN3D_LIBRARIES Coin
      PATHS
      $ENV{EXTERNLIBS}/Inventor.framework/Libraries
  ...
  ELSE(APPLE)
    ...
    FIND_PATH(COIN3D_INCLUDE_DIRS Inventor/So.h
      PATHS $ENV{COIN3D_HOME}/include $ENV{EXTERNLIBS}/Coin3D/include $ENV{COINDIR}/include /usr/include/coin
      NO_DEFAULT_PATH
    )
    FIND_PATH(COIN3D_INCLUDE_DIRS Inventor/So.h)
