...
IF (MSVC)
    ...
    IF(MSVC_IDE)
      ...
      ELSE (HDF5_HL_LIBRARY_DEBUG AND HDF5_HL_LIBRARY_DEBUG)
         SET(HDF5_HL_LIBRARIES NOTFOUND)
         MESSAGE(STATUS "Could not find the debug AND release version of HDF5_HL")
      ENDIF (HDF5_HL_LIBRARY_DEBUG AND HDF5_HL_LIBRARY_DEBUG)
      IF (HDF5_CPP_LIBRARY_DEBUG AND HDF5_CPP_LIBRARY_RELEASE)
         SET(HDF5_CPP_LIBRARIES optimized ${HDF5_CPP_LIBRARY_RELEASE} debug ${HDF5_CPP_LIBRARY_DEBUG} optimized ${HDF5_HL_CPP_LIBRARY_RELEASE} debug ${HDF5_HL_CPP_LIBRARY_DEBUG})
      ELSE (HDF5_CPP_LIBRARY_DEBUG AND HDF5_CPP_LIBRARY_RELEASE)
         SET(HDF5_CPP_LIBRARIES NOTFOUND)
         MESSAGE(STATUS "Could not find the debug AND release version of HDF5_CPP")
      ENDIF (HDF5_CPP_LIBRARY_DEBUG AND HDF5_CPP_LIBRARY_RELEASE)
	  
      IF (HDF5_HL_CPP_LIBRARY_DEBUG AND HDF5_HL_CPP_LIBRARY_RELEASE)
         SET(HDF5_HL_CPP_LIBRARIES ${HDF5_HL_CPP_LIBRARY_RELEASE} debug ${HDF5_HL_CPP_LIBRARY_DEBUG})
      ELSE (HDF5_HL_CPP_LIBRARY_DEBUG AND HDF5_HL_CPP_LIBRARY_RELEASE)
         SET(HDF5_HL_CPP_LIBRARIES NOTFOUND)
         MESSAGE(STATUS "Could not find the debug AND release version of HDF5_HL_CPP")
      ENDIF (HDF5_HL_CPP_LIBRARY_DEBUG AND HDF5_HL_CPP_LIBRARY_RELEASE)
    ELSE(MSVC_IDE)
