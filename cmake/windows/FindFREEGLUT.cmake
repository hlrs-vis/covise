...
SET(FREEGLUT_DBG_NAMES freeglutd freeglut_staticd )
...
ELSE (WIN32)
  ...
  FIND_LIBRARY(FREEGLUT_LIBRARY_DEBUG NAMES ${FREEGLUT_DBG_NAMES}
    PATHS
    ...
    /opt/csw
    /opt
    [HKEY_LOCAL_MACHINE\\SOFTWARE\\Creative\ Labs\\FREEGLUT\ 1.1\ Software\ Development\ Kit\\1.00.0000;InstallDir]
    PATH_SUFFIXES lib64 lib libs64 libs libs/Win32 libs/Win64
    DOC "Freeglut - Library (Debug)"
  )
  
  IF(FREEGLUT_LIBRARY_DEBUG AND FREEGLUT_LIBRARY)
    SET(FREEGLUT_LIBRARIES optimized ${FREEGLUT_LIBRARY} debug ${FREEGLUT_LIBRARY_DEBUG})
  ENDIF(FREEGLUT_LIBRARY_DEBUG AND FREEGLUT_LIBRARY)

  FIND_PACKAGE_HANDLE_STANDARD_ARGS(FREEGLUT DEFAULT_MSG FREEGLUT_LIBRARY FREEGLUT_LIBRARY_DEBUG FREEGLUT_INCLUDE_DIR)

  MARK_AS_ADVANCED(FREEGLUT_LIBRARY FREEGLUT_LIBRARY_DEBUG FREEGLUT_INCLUDE_DIR)
