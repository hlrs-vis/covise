   ...
   if(COVISE_USE_QT4)
      ...
      find_package(Qt5WebEngine QUIET)
          if (Qt5WebEngine_FOUND)
            message("Qt5WebEngine was found")
            else()
            message("Qt5WebEngine was NOT found")
          endif()
      find_package(Qt5WebEngineWidgets QUIET)
        if (Qt5WebEngineWidgets_FOUND)
        message("Qt5WebEngineWidgets was found")
        else()
        message("Qt5WebEngineWidgets was NOT found")
        endif()
      if (Qt5WebEngine_FOUND AND Qt5WebEngineWidgets_FOUND)
        message("Qt5WebEngine and Qt5WebEngineWidgets was found")
        set(COVISE_USE_WEBENGINE TRUE)
      else()
      message("Qt5WebEngine and Qt5WebEngineWidgets was NOT found")
        find_package(Qt5WebKit QUIET)
        find_package(Qt5WebKitWidgets QUIET)
        if (Qt5WebKit_FOUND AND Qt5WebKitWidgets_FOUND)
        message("Qt5WebKit and Qt5WebKitWidgets was found")
          set(COVISE_USE_WEBKIT TRUE)
          else()
          message("Qt5WebKit and Qt5WebKitWidgets was NOT found")
        endif()
      endif()
