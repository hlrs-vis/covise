...
IF(MSVC)
  ...
  IF(OPENPASS_COMMON_LIBRARY_DEBUG AND OPENPASS_COMMON_LIBRARY)
    SET(OPENPASS_LIBRARIES optimized ${OPENPASS_COMMON_LIBRARY} debug ${OPENPASS_COMMON_LIBRARY_DEBUG} optimized ${OPENPASS_CORE_SLAVE_LIBRARY} debug ${OPENPASS_CORE_SLAVE_LIBRARY_DEBUG})
  ENDIF(OPENPASS_COMMON_LIBRARY_DEBUG AND OPENPASS_COMMON_LIBRARY)

  FIND_PACKAGE_HANDLE_STANDARD_ARGS(OPENPASS DEFAULT_MSG OPENPASS_COMMON_LIBRARY OPENPASS_COMMON_LIBRARY_DEBUG OPENPASS_CORE_SLAVE_LIBRARY OPENPASS_CORE_SLAVE_LIBRARY_DEBUG)

  MARK_AS_ADVANCED(OPENPASS_COMMON_LIBRARY OPENPASS_COMMON_LIBRARY_DEBUG OPENPASS_CORE_SLAVE_LIBRARY OPENPASS_CORE_SLAVE_LIBRARY_DEBUG)
  
ELSE(MSVC)
  # rest of the world
    SET(OPENPASS_LIBRARIES ${OPENPASS_COMMON_LIBRARY} ${OPENPASS_CORE_SLAVE_LIBRARY})

  FIND_PACKAGE_HANDLE_STANDARD_ARGS(OPENPASS DEFAULT_MSG OPENPASS_COMMON_LIBRARY  OPENPASS_CORE_SLAVE_LIBRARY)
  
  MARK_AS_ADVANCED(OPENPASS_COMMON_LIBRARY  OPENPASS_CORE_SLAVE_LIBRARY )
