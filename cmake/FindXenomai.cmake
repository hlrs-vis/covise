...
if( UNIX )
  ...
  if( XENOMAI_DIR ) 
    ...
    if( COVISE_USE_MERCURY )
      ...
      find_library( XENOMAI_LIBRARY_FUSE fuse  ${XENOMAI_DIR}/lib )
      set(XENOMAI_DEFINITIONS "-DMERCURY  -D__XENO__")
      set( XENOMAI_INCLUDE_DIR ${XENOMAI_DIR}/include  ${XENOMAI_DIR}/include/mercury)
      set(XENOMAI_LIBRARIES ${XENOMAI_LIBRARY_ALCHEMY} ${XENOMAI_LIBRARY_COPPERPLATE} ${XENOMAI_LIBRARY_MERCURY} ${XENOMAI_LIBRARY_FUSE})
      ...
      set(XENOMAI_LIBRARIES  ${XENOMAI_LIBRARY_ALCHEMY} ${XENOMAI_LIBRARY_COPPERPLATE}  ${XENOMAI_LIBRARY_COBALT} ${XENOMAI_LIBRARY_FUSE})
