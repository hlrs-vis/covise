...
macro(find_qt)
   ...
   if(NOT COVISE_USE_QT5)
       covise_find_package(Qt6 COMPONENTS Core Gui Xml Network Core5Compat ${required})
       covise_find_package(Qt6 COMPONENTS WebEngineWidgets WebView UiTools Quick Svg SvgWidgets OpenGL OpenGLWidgets PrintSupport)
...
macro(qt_use_modules target)
    if(NOT COVISE_USE_QT5)
       ...
       target_link_libraries(${target} Qt6::Core5Compat)
      foreach(mod ${ARGN})
