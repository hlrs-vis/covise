...
FUNCTION(COVISE_ADJUST_OUTPUT_DIR targetname)
  ...
  IF(TARGET_TYPE)
    ...
    ELSE(CMAKE_CONFIGURATION_TYPES)
      ...
      ELSE(COVISE_DESTDIR)
        SET_TARGET_PROPERTIES(${ARGV0} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_${upper_build_type_str} "${CMAKE_BINARY_DIR}/${ARCHSUFFIX}/${BINLIB_SUFFIX}${MYPATH_POSTFIX}")
        SET_TARGET_PROPERTIES(${ARGV0} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_${upper_build_type_str} "${CMAKE_BINARY_DIR}/${ARCHSUFFIX}/${BINLIB_SUFFIX}${MYPATH_POSTFIX}")
        SET_TARGET_PROPERTIES(${ARGV0} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_${upper_build_type_str} "${CMAKE_BINARY_DIR}/${ARCHSUFFIX}/${BINLIB_SUFFIX}${MYPATH_POSTFIX}")
      ENDIF(COVISE_DESTDIR)
   ...
   IF(CUDA_FOUND AND COVISE_USE_CUDA)
      ...
      if("${CUDA_VERSION}" VERSION_LESS 7.0)
          ...
          elseif(${BASEARCHSUFFIX} STREQUAL "werewolf")
              SET(CUDA_HOST_COMPILER ${COVISEDIR}/scripts/cuda-host-compiler CACHE STRING "CUDA nvcc host compiler" FORCE)
          elseif(${BASEARCHSUFFIX} STREQUAL "rosa")
              SET(CUDA_HOST_COMPILER ${COVISEDIR}/scripts/cuda-host-compiler CACHE STRING "CUDA nvcc host compiler" FORCE)
          endif()
      else()
	      if(WIN32)
