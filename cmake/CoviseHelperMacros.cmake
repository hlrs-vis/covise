...
ENDIF(APPLE)
  ...
  IF(NOT MINGW AND NOT APPLE)
    if (NOT "" STREQUAL "${COVISE_MAJOR_VERSION}" AND NOT "" STREQUAL "${COVISE_MINOR_VERSION}")
       SET_TARGET_PROPERTIES(${targetname} PROPERTIES VERSION "${COVISE_MAJOR_VERSION}.${COVISE_MINOR_VERSION}")
    endif()
  ENDIF()
...
MACRO(COVISE_FIND_CUDA)
   ...
   IF(CUDA_FOUND AND COVISE_USE_CUDA)
      ...
      IF(APPLE)
         FIND_PROGRAM(GCC_EXECUTABLE gcc DOC "GCC executable")
         SET(CUDA_HOST_COMPILER ${COVISEDIR}/scripts/cuda-host-compiler CACHE STRING "CUDA nvcc host compiler" FORCE)
         SET(CUDA_NVCC_FLAGS "\"-DBOOST_NOINLINE=__attribute__ ((noinline))\"")
      ENDIF(APPLE)
      if(${BASEARCHSUFFIX} STREQUAL "rhel6")
         SET(CUDA_HOST_COMPILER ${COVISEDIR}/scripts/cuda-host-compiler CACHE STRING "CUDA nvcc host compiler" FORCE)
      endif()
      if(${BASEARCHSUFFIX} STREQUAL "rhel7")
         SET(CUDA_HOST_COMPILER ${COVISEDIR}/scripts/cuda-host-compiler CACHE STRING "CUDA nvcc host compiler" FORCE)
      endif()
