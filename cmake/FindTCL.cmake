...
IF(MSVC)
FIND_LIBRARY(TCL_DEBUG_LIBRARY
  NAMES 
  tclg   
...
SET(TCL_LIBRARIES optimized ${TCL_LIBRARY} debug ${TCL_DEBUG_LIBRARY})
ENDIF(MSVC)
...
SET(TK_LIBRARIES optimized ${TK_LIBRARY} debug ${TK_DEBUG_LIBRARY})
ENDIF(MSVC)
