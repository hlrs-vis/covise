...
if( WIN32 )
  ...
  PATHS
   ...
   if ( PKG_CONFIG_FOUND )
      ...
      pkg_check_modules( PC_FFMPEG_SWRESAMPLE libswresample )
   ...
   FIND_PATH(FFMPEG_SWRESAMPLE_INCLUDE_DIR
      ...
      HINTS ${PC_FFMPEG_SWRESAMPLE_INCLUDE_DIRS} /usr/include
      PATH_SUFFIXES ${FFMPEG_PATH_SUFFIX})
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(FFMPEG_SWSCALE REQUIRED_VARS
   FFMPEG_SWSCALE_LIBRARY FFMPEG_SWSCALE_INCLUDE_DIR
   NAME_MISMATCHED
   )
FIND_PACKAGE_HANDLE_STANDARD_ARGS(FFMPEG_SWRESAMPLE REQUIRED_VARS
...
IF(FFMPEG_FOUND)
   ...
   IF(FFMPEG_SWRESAMPLE_FOUND)
      SET(FFMPEG_INCLUDE_DIRS ${FFMPEG_INCLUDE_DIRS} ${FFMPEG_SWRESAMPLE_INCLUDE_DIR})
      SET(FFMPEG_LIBRARIES ${FFMPEG_LIBRARIES} ${FFMPEG_SWRESAMPLE_LIBRARY})
   ENDIF(FFMPEG_SWRESAMPLE_FOUND)
ENDIF(FFMPEG_FOUND)
