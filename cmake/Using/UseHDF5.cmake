MACRO(USE_HDF5)
  ...
  if (component STREQUAL "all")
      SET(EXTRA_LIBS ${EXTRA_LIBS} ${HDF5_LIBRARIES} ${HDF5_HL_LIBRARIES} ${HDF5_CXX_LIBRARIES} ${HDF5_HL_CXX_LIBRARIES} ${WINLIBS})
  elseif (component STREQUAL "hl")
      SET(EXTRA_LIBS ${EXTRA_LIBS} ${HDF5_LIBRARIES} ${HDF5_HL_LIBRARIES} ${WINLIBS})
  elseif (component STREQUAL "c")
      SET(EXTRA_LIBS ${EXTRA_LIBS} ${HDF5_LIBRARIES} ${WINLIBS})
  elseif (component STREQUAL "cxx_hl")
      SET(EXTRA_LIBS ${EXTRA_LIBS}  ${HDF5_LIBRARIES} ${HDF5_CXX_LIBRARIES} ${HDF5_HL_CXX_LIBRARIES} ${WINLIBS})
  elseif (component STREQUAL "cxx")
      SET(EXTRA_LIBS ${EXTRA_LIBS}  ${HDF5_LIBRARIES} ${HDF5_CXX_LIBRARIES} ${WINLIBS})
  endif()
ENDMACRO(USE_HDF5)
