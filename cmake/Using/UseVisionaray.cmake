        ...
        IF(NOT VISIONARAY_USED)
            ...
            if(MSVC)
                ...
                if(BUILD_SHARED_LIBS)
                    set(VISIONARAY_LIBRARY "${COVISEDIR}/${COVISE_ARCHSUFFIX}/lib/libvisionaray${CMAKE_SHARED_LIBRARY_SUFFIX}")
                else()
                    set(VISIONARAY_LIBRARY "${COVISEDIR}/${COVISE_ARCHSUFFIX}/lib/libvisionaray${CMAKE_STATIC_LIBRARY_SUFFIX}")
                endif()
            endif()
