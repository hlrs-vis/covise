...
IF (WIN32)
  ...
  if (NOT TBB_LIBRARY)
    ...
    FIND_LIBRARY(TBB_LIBRARY tbb PATHS ${TBB_LIBDIR} NO_DEFAULT_PATH)
    FIND_LIBRARY(TBB_LIBRARY_MALLOC tbbmalloc PATHS ${TBB_LIBDIR} NO_DEFAULT_PATH)
    FIND_LIBRARY(TBB_LIBRARY_DEBUG tbb_debug PATHS ${TBB_LIBDIR} ${TBB_DEBUGLIBDIR} NO_DEFAULT_PATH)
    FIND_LIBRARY(TBB_LIBRARY_MALLOC_DEBUG tbbmalloc_debug PATHS ${TBB_LIBDIR} ${TBB_DEBUGLIBDIR} NO_DEFAULT_PATH)
  endif()

  FIND_PACKAGE_HANDLE_STANDARD_ARGS(TBB DEFAULT_MSG TBB_INCLUDE_DIR TBB_LIBRARY TBB_LIBRARY_MALLOC TBB_LIBRARY_DEBUG TBB_LIBRARY_MALLOC_DEBUG)

  IF (TBB_FOUND)
    SET(TBB_INCLUDE_DIRS ${TBB_INCLUDE_DIR})
    SET(TBB_LIBRARIES
      optimized ${TBB_LIBRARY} ${TBB_LIBRARY_MALLOC}
      debug ${TBB_LIBRARY_DEBUG} ${TBB_LIBRARY_MALLOC_DEBUG})
  ENDIF()
