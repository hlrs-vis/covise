...
IF (WIN32)
  IF (CYGWIN)
    ...
    FIND_PATH(COIN3D_INCLUDE_DIRS Inventor/So.h
      PATHS $ENV{COIN3D_HOME}/include $ENV{EXTERNLIBS}/Coin3D/include $ENV{COINDIR}/include
      NO_DEFAULT_PATH
    )
    FIND_PATH(COIN3D_INCLUDE_DIRS Inventor/So.h)

    FIND_LIBRARY(COIN3D_LIBRARIES coin5 coin4 coin3 coin2 coin1 Coin
      PATHS $ENV{COIN3D_HOME}/lib $ENV{EXTERNLIBS}/Coin3D/lib $ENV{COINDIR}/lib
      NO_DEFAULT_PATH
    )
    FIND_LIBRARY(COIN3D_LIBRARIES coin5 coin4 coin3 coin2 coin1 Coin)
  ...
  ELSE (CYGWIN)
    ...
    FIND_LIBRARY(COIN3D_LIBRARY_DEBUG coin5d coin4d coin3d coin2d coin1d Coind
      PATHS $ENV{COIN3D_HOME}/lib $ENV{EXTERNLIBS}/Coin3D/lib $ENV{COINDIR}/lib
      "[HKEY_LOCAL_MACHINE\\SOFTWARE\\SIM\\Coin3D\\2;Installation Path]/lib"
    )

    FIND_LIBRARY(COIN3D_LIBRARY_RELEASE coin5 coin4 coin3 coin2 coin1 Coin
      PATHS $ENV{COIN3D_HOME}/lib $ENV{EXTERNLIBS}/Coin3D/lib $ENV{COINDIR}/lib
      "[HKEY_LOCAL_MACHINE\\SOFTWARE\\SIM\\Coin3D\\2;Installation Path]/lib"
    )
...
ELSE (WIN32)
  IF(APPLE)
    FIND_FILE(COIN3D_FRAMEWORK Inventor.framework
      PATHS
      /Library/Frameworks
    )
    FIND_PATH(COIN3D_INCLUDE_DIRS Inventor/So.h
      HINTS
      ${COIN3D_FRAMEWORK}/Headers
      PATHS
      /Library/Frameworks/Inventor.framework/Headers 
    )
    FIND_LIBRARY(COIN3D_LIBRARIES Coin
      HINTS
      ${COIN3D_FRAMEWORK}/Libraries
      PATHS
      /Library/Frameworks/Inventor.framework/Libraries
    )   
    SET(COIN3D_INCLUDE_DIRS "${COIN3D_FRAMEWORK}" CACHE STRING "Coin3D framework for OS X")
    SET(COIN3D_LIBRARIES "${COIN3D_FRAMEWORK}" CACHE STRING "Coin3D library for OS X")
  ELSE(APPLE)
...
MARK_AS_ADVANCED(COIN3D_INCLUDE_DIRS COIN3D_LIBRARIES COIN3D_LIBRARY_RELEASE COIN3D_LIBRARY_DEBUG)
