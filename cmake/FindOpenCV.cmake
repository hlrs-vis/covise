...
FIND_PATH(OPENCV_INCLUDE_DIR "opencv2/core/core.hpp"
  ...
  /opt/homebrew/opt/opencv@3/include
...
IF(MSVC)
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(OPENCV_${_uppercomponent} DEFAULT_MSG OPENCV_${_uppercomponent}_LIBRARY OPENCV_${_uppercomponent}_LIBRARY_DEBUG OPENCV_INCLUDE_DIR)
...
ELSE(MSVC)
  ...
  FIND_PACKAGE_HANDLE_STANDARD_ARGS(OPENCV_${_uppercomponent} DEFAULT_MSG OPENCV_${_uppercomponent}_LIBRARY OPENCV_INCLUDE_DIR)
