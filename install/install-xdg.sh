...
xdg-desktop-menu install --noupdate hlrs-covise-daemon.desktop
xdg-mime default hlrs-cover.desktop x-scheme-handler/cover
xdg-desktop-menu forceupdate

xdg-icon-resource install --noupdate --size 48 hlrs-cover.png
xdg-icon-resource install --noupdate --size 48 hlrs-covise.png
xdg-icon-resource install --noupdate --size 48 hlrs-covise-daemon.png
